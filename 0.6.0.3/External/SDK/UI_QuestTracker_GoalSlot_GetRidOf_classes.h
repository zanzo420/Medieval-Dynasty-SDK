...
// WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_GetRidOf.UI_QuestTracker_GoalSlot_GetRidOf_C
// 0x0061 (FullSize[0x02E9] - InheritedSize[0x0288])
class UUI_QuestTracker_GoalSlot_GetRidOf_C : public UUI_QuestTracker_MasterGoalSlot_C
{
public:
	...
	class UTextBlock*                                  txt_GotRidOf;                                              // 0x02B0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FText                                       GoalText;                                                  // 0x02B8(0x0018) (Edit, BlueprintVisible, ExposeOnSpawn)
	int                                                ToGetRidOf;                                                // 0x02D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	int                                                GotRidOf;                                                  // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_GetRidOf.UI_QuestTracker_GoalSlot_GetRidOf_C");
		return ptr;
	}
	...
	void Remove();
	void Construct();
	void ExecuteUbergraph_UI_QuestTracker_GoalSlot_GetRidOf(int EntryPoint);
