...
// WidgetBlueprintGeneratedClass UI_GoalSlot_CompleteQuests.UI_GoalSlot_CompleteQuests_C
// 0x0060 (FullSize[0x02C0] - InheritedSize[0x0260])
class UUI_GoalSlot_CompleteQuests_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_1G7Z[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_CompleteQuests                     Goal;                                                      // 0x0290(0x0028) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalSlot_CompleteQuests.UI_GoalSlot_CompleteQuests_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalSlot_CompleteQuests(int EntryPoint);
