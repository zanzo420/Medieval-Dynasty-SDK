...
// WidgetBlueprintGeneratedClass UI_SaveGameSlot_Labels.UI_SaveGameSlot_Labels_C
// 0x0098 (FullSize[0x02F8] - InheritedSize[0x0260])
class UUI_SaveGameSlot_Labels_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_CCUT[0x3];                                     // 0x02C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NEF7[0x4];                                     // 0x02CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IZFM[0x5];                                     // 0x02E3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     GameVersion;                                               // 0x02E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_SaveGameSlot_Labels.UI_SaveGameSlot_Labels_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_SaveGameSlot_Labels(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
