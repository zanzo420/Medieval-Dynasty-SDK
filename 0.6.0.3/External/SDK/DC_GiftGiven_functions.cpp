...
// Function DC_GiftGiven.DC_GiftGiven_C.IsConditionMet
...
bool UDC_GiftGiven_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_GiftGiven.DC_GiftGiven_C.IsConditionMet");

	UDC_GiftGiven_C_IsConditionMet_Params params;
...
void UDC_GiftGiven_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_GiftGiven_C::BeforeDelete()
{
