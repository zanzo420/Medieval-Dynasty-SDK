...
// BlueprintGeneratedClass BTService_Follow.BTService_Follow_C
// 0x00C0 (FullSize[0x0158] - InheritedSize[0x0098])
class UBTService_Follow_C : public UBTService_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_M3P5[0x4];                                     // 0x012C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBlackboardKeySelector                      RotateToPlayer;                                            // 0x0130(0x0028) (Edit, BlueprintVisible)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTService_Follow.BTService_Follow_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTService_Follow(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
