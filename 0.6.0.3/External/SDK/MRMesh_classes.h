...
public:
	...
	unsigned char                                      UnknownData_19WM[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C9FS[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YIYJ[0x20];                                    // 0x0250(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MH5A[0x10];                                    // 0x0440(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OJ4Q[0x5];                                     // 0x0463(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0KX6[0x80];                                    // 0x0480(0x0080) MISSED OFFSET (PADDING)
