...
// BlueprintGeneratedClass BP_Prey_Moose_Female.BP_Prey_Moose_Female_C
// 0x0018 (FullSize[0x0C00] - InheritedSize[0x0BE8])
class ABP_Prey_Moose_Female_C : public ABP_PreyAI_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prey_Moose_Female.BP_Prey_Moose_Female_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Prey_Moose_Female(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
