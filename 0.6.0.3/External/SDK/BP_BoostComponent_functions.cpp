...
void UBP_BoostComponent_C::AfterRead()
{
	UActorComponent::AfterRead();

	READ_PTR_FULL(OwnerComponent, ACharacter);
	READ_PTR_FULL(CharacterMovement, UCharacterMovementComponent);
	READ_PTR_FULL(SkeletalMeshOwner, USkeletalMeshComponent);
	READ_PTR_FULL(Controller, AAIController);
	READ_PTR_FULL(HiddenActorComponent, UArrowComponent);
}

void UBP_BoostComponent_C::BeforeDelete()
{
	UActorComponent::BeforeDelete();

	DELE_PTR_FULL(OwnerComponent);
	DELE_PTR_FULL(CharacterMovement);
	DELE_PTR_FULL(SkeletalMeshOwner);
	DELE_PTR_FULL(Controller);
	DELE_PTR_FULL(HiddenActorComponent);
}
