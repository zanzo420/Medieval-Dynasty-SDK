...
// WidgetBlueprintGeneratedClass UI_FieldChangeAcceptation.UI_FieldChangeAcceptation_C
// 0x0088 (FullSize[0x02E8] - InheritedSize[0x0260])
class UUI_FieldChangeAcceptation_C : public UUserWidget
{
public:
	...
	class UTextBlock*                                  txt_TabName;                                               // 0x02B8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UWidgetSwitcher*                             WidgetSwitcher_2;                                          // 0x02C8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UUI_ManagementDetails_Field_C*               FieldManagementReference;                                  // 0x02D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	struct FScriptMulticastDelegate                    ActionDispatcher;                                          // 0x02D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_FieldChangeAcceptation.UI_FieldChangeAcceptation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_FieldChangeAcceptation(int EntryPoint);
