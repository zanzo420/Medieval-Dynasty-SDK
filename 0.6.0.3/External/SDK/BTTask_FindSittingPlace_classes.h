...
// BlueprintGeneratedClass BTTask_FindSittingPlace.BTTask_FindSittingPlace_C
// 0x00D8 (FullSize[0x0180] - InheritedSize[0x00A8])
class UBTTask_FindSittingPlace_C : public UBTTask_BlueprintBase
{
public:
	...
	struct FBlackboardKeySelector                      TargetLocation;                                            // 0x0108(0x0028) (Edit, BlueprintVisible)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_FindSittingPlace.BTTask_FindSittingPlace_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_FindSittingPlace(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
