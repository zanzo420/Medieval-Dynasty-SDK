...
public:
	...
	unsigned char                                      UnknownData_F3ND[0x1B];                                    // 0x0065(0x001B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6S4G[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0GSQ[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A3AG[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
