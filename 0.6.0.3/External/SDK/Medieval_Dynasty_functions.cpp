...
void AAnimalCharacter::AfterRead()
{
	ACharacter::AfterRead();

	READ_PTR_FULL(BodyCollision, UCapsuleComponent);
	READ_PTR_FULL(PawnMovement, UPawnMovementComponent);
}

void AAnimalCharacter::BeforeDelete()
{
	ACharacter::BeforeDelete();

	DELE_PTR_FULL(BodyCollision);
	DELE_PTR_FULL(PawnMovement);
}
...
void UBPCppHelperFunctions::AfterRead()
{
	UBlueprintFunctionLibrary::AfterRead();

}

void UBPCppHelperFunctions::BeforeDelete()
{
...
void UCustomCapsuleComponent::AfterRead()
{
	UCapsuleComponent::AfterRead();

}

void UCustomCapsuleComponent::BeforeDelete()
{
...
void ACustomDetourCrowdAIC::AfterRead()
{
	AAIController::AfterRead();

	READ_PTR_FULL(CrowdFollowingComponent, UCrowdFollowingComponent);
}

void ACustomDetourCrowdAIC::BeforeDelete()
{
	AAIController::BeforeDelete();

	DELE_PTR_FULL(CrowdFollowingComponent);
}

void UCustomFoliageInstancedSMComp::AfterRead()
{
	UFoliageInstancedStaticMeshComponent::AfterRead();

}

void UCustomFoliageInstancedSMComp::BeforeDelete()
{
	UFoliageInstancedStaticMeshComponent::BeforeDelete();

}

void UGI_MedievalDynastyBase::AfterRead()
{
	UGameInstance::AfterRead();

}

void UGI_MedievalDynastyBase::BeforeDelete()
{
	UGameInstance::BeforeDelete();

}

void UMultiCollisionCapsuleComponent::AfterRead()
{
	UCapsuleComponent::AfterRead();

}

void UMultiCollisionCapsuleComponent::BeforeDelete()
{
	UCapsuleComponent::BeforeDelete();

}

void AMultiCollisionCharacter::AfterRead()
{
	ACharacter::AfterRead();

}

void AMultiCollisionCharacter::BeforeDelete()
{
	ACharacter::BeforeDelete();

}

void UMultiCollisionMovementComponent::AfterRead()
{
	UCharacterMovementComponent::AfterRead();

	READ_PTR_FULL(LastBlockedComponent, UPrimitiveComponent);
}

void UMultiCollisionMovementComponent::BeforeDelete()
{
	UCharacterMovementComponent::BeforeDelete();

	DELE_PTR_FULL(LastBlockedComponent);
}
