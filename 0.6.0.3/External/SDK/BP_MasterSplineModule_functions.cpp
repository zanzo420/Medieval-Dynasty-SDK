...
void UBP_MasterSplineModule_C::AfterRead()
{
	USplineMeshComponent::AfterRead();

	READ_PTR_FULL(SplineStructureReference, ABP_MasterSplineStructure_C);
...
void UBP_MasterSplineModule_C::BeforeDelete()
{
	USplineMeshComponent::BeforeDelete();

	DELE_PTR_FULL(SplineStructureReference);
