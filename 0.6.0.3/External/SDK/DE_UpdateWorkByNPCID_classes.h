...
// BlueprintGeneratedClass DE_UpdateWorkByNPCID.DE_UpdateWorkByNPCID_C
// 0x0019 (FullSize[0x0041] - InheritedSize[0x0028])
class UDE_UpdateWorkByNPCID_C : public UDialogueEvents
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DE_UpdateWorkByNPCID.DE_UpdateWorkByNPCID_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_DE_UpdateWorkByNPCID(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
