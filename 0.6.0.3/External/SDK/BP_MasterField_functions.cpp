...
void ABP_MasterField_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(InspectorPoint, USphereComponent);
	READ_PTR_FULL(AllowedToBuild, UBoxComponent);
	READ_PTR_FULL(TempLocationA, UArrowComponent);
	READ_PTR_FULL(InstancedStaticMesh, UInstancedStaticMeshComponent);
	READ_PTR_FULL(Ghost, UStaticMeshComponent);
	READ_PTR_FULL(TempLocationB, UArrowComponent);
	READ_PTR_FULL(DefaultSceneRoot, USceneComponent);
	READ_PTR_FULL(SystemsManagerReference, ABP_SystemsManager_C);
	READ_PTR_FULL(InteractAnimation, UAnimMontage);
	READ_PTR_FULL(InteractFemaleAnimation, UAnimMontage);
	READ_PTR_FULL(Mesh, UStaticMesh);
	READ_PTR_FULL(GhostMaterialReference, UMaterialInstanceDynamic);
	READ_PTR_FULL(Mesh_Wheat_Spring2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Wheat_Autumn2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Rye2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Oat2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Flax2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Beetroot2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Onion2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cabbage_Spring2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cabbage_Summer2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Carrot_Spring2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Carrot_Winter2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh__Wheat_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Rye_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Oat_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Flax_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Beetroot_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Onion_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cabbage_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Carrot_Harvested2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(GhostConstructedMaterialReference, UMaterialInstanceDynamic);
}

void ABP_MasterField_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(InspectorPoint);
	DELE_PTR_FULL(AllowedToBuild);
	DELE_PTR_FULL(TempLocationA);
	DELE_PTR_FULL(InstancedStaticMesh);
	DELE_PTR_FULL(Ghost);
	DELE_PTR_FULL(TempLocationB);
	DELE_PTR_FULL(DefaultSceneRoot);
	DELE_PTR_FULL(SystemsManagerReference);
	DELE_PTR_FULL(InteractAnimation);
	DELE_PTR_FULL(InteractFemaleAnimation);
	DELE_PTR_FULL(Mesh);
	DELE_PTR_FULL(GhostMaterialReference);
	DELE_PTR_FULL(Mesh_Wheat_Spring2);
	DELE_PTR_FULL(Mesh_Wheat_Autumn2);
	DELE_PTR_FULL(Mesh_Rye2);
	DELE_PTR_FULL(Mesh_Oat2);
	DELE_PTR_FULL(Mesh_Flax2);
	DELE_PTR_FULL(Mesh_Beetroot2);
	DELE_PTR_FULL(Mesh_Onion2);
	DELE_PTR_FULL(Mesh_Cabbage_Spring2);
	DELE_PTR_FULL(Mesh_Cabbage_Summer2);
	DELE_PTR_FULL(Mesh_Carrot_Spring2);
	DELE_PTR_FULL(Mesh_Carrot_Winter2);
	DELE_PTR_FULL(Mesh__Wheat_Harvested2);
	DELE_PTR_FULL(Mesh_Rye_Harvested2);
	DELE_PTR_FULL(Mesh_Oat_Harvested2);
	DELE_PTR_FULL(Mesh_Flax_Harvested2);
	DELE_PTR_FULL(Mesh_Beetroot_Harvested2);
	DELE_PTR_FULL(Mesh_Onion_Harvested2);
	DELE_PTR_FULL(Mesh_Cabbage_Harvested2);
	DELE_PTR_FULL(Mesh_Carrot_Harvested2);
	DELE_PTR_FULL(GhostConstructedMaterialReference);
}
