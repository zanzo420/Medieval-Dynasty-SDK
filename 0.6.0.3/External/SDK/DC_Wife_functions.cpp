...
// Function DC_Wife.DC_Wife_C.IsConditionMet
...
bool UDC_Wife_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_Wife.DC_Wife_C.IsConditionMet");

	UDC_Wife_C_IsConditionMet_Params params;
...
void UDC_Wife_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_Wife_C::BeforeDelete()
{
