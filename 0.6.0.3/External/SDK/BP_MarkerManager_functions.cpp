...
void ABP_MarkerManager_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(DefaultSceneRoot, USceneComponent);
	READ_PTR_FULL(PlayerPlacedMarker, ABP_MasterMarker_C);
}

void ABP_MarkerManager_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(DefaultSceneRoot);
	DELE_PTR_FULL(PlayerPlacedMarker);
}
