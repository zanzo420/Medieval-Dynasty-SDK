...
// Function DC_AnswerAnimal.DC_AnswerAnimal_C.IsConditionMet
...
bool UDC_AnswerAnimal_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_AnswerAnimal.DC_AnswerAnimal_C.IsConditionMet");

	UDC_AnswerAnimal_C_IsConditionMet_Params params;
...
void UDC_AnswerAnimal_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_AnswerAnimal_C::BeforeDelete()
{
