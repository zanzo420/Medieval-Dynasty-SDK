...
// WidgetBlueprintGeneratedClass UI_TutorialMessage_Taxes.UI_TutorialMessage_Taxes_C
// 0x003F (FullSize[0x02A0] - InheritedSize[0x0261])
class UUI_TutorialMessage_Taxes_C : public UUI_MasterTutorialMessage_C
{
public:
	unsigned char                                      UnknownData_KV2G[0x7];                                     // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_TutorialMessage_Taxes.UI_TutorialMessage_Taxes_C");
		return ptr;
	}
	...
	void Remove();
	void ExecuteUbergraph_UI_TutorialMessage_Taxes(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
