...
struct ABP_Trap_FishingNetBig_C_Catch_Params
{
	bool                                               Load;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function BP_Trap_FishingNetBig.BP_Trap_FishingNetBig_C.PickUpAnimal
struct ABP_Trap_FishingNetBig_C_PickUpAnimal_Params
{
...
struct ABP_Trap_FishingNetBig_C_ExecuteUbergraph_BP_Trap_FishingNetBig_Params
{
