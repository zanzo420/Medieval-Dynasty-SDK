...
void UUI_BuildingDetails_ProfessionSlot_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Img_Skill, UImage);
	READ_PTR_FULL(txt_ProfessionName, UTextBlock);
	READ_PTR_FULL(txt_SkillName, UTextBlock);
}

void UUI_BuildingDetails_ProfessionSlot_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Img_Skill);
	DELE_PTR_FULL(txt_ProfessionName);
