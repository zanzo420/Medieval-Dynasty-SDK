...
void ABP_BuildSocket_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(Slot, UArrowComponent);
	READ_PTR_FULL(Box, UBoxComponent);
	READ_PTR_FULL(Scene, USceneComponent);
	READ_PTR_FULL(CaveReference, ABP_Cave_C);
}

void ABP_BuildSocket_C::BeforeDelete()
{
	AActor::BeforeDelete();
