...
void UUI_CreditsSlot_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(txt_PersonName, UTextBlock);
	READ_PTR_FULL(txt_RoleText, UTextBlock);
}

void UUI_CreditsSlot_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(txt_PersonName);
	DELE_PTR_FULL(txt_RoleText);
}
