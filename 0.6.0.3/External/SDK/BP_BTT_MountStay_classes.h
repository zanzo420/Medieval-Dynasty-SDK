...
// BlueprintGeneratedClass BP_BTT_MountStay.BP_BTT_MountStay_C
// 0x0018 (FullSize[0x00C0] - InheritedSize[0x00A8])
class UBP_BTT_MountStay_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BTT_MountStay.BP_BTT_MountStay_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BTT_MountStay(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
