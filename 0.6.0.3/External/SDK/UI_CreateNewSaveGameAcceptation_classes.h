...
// WidgetBlueprintGeneratedClass UI_CreateNewSaveGameAcceptation.UI_CreateNewSaveGameAcceptation_C
// 0x00A8 (FullSize[0x0308] - InheritedSize[0x0260])
class UUI_CreateNewSaveGameAcceptation_C : public UUserWidget
{
public:
	...
	TArray<struct FString>                             InvalidFileSymbols;                                        // 0x02D0(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FString>                             InvalidFileNames;                                          // 0x02E0(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       tmp_OldText;                                               // 0x02F0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_CreateNewSaveGameAcceptation.UI_CreateNewSaveGameAcceptation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_CreateNewSaveGameAcceptation(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
