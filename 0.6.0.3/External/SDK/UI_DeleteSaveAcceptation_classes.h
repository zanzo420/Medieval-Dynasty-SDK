...
// WidgetBlueprintGeneratedClass UI_DeleteSaveAcceptation.UI_DeleteSaveAcceptation_C
// 0x0070 (FullSize[0x02D0] - InheritedSize[0x0260])
class UUI_DeleteSaveAcceptation_C : public UUserWidget
{
public:
	...
	class UUI_LoadMenu_C*                              LoadMenuReference;                                         // 0x02C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_DeleteSaveAcceptation.UI_DeleteSaveAcceptation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_DeleteSaveAcceptation(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
