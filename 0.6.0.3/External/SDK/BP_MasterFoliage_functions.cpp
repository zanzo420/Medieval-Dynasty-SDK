...
void UBP_MasterFoliage_C::AfterRead()
{
	UFoliageInstancedStaticMeshComponent::AfterRead();

	READ_PTR_FULL(ReplaceFoliageType, UFoliageType_InstancedStaticMesh);
	READ_PTR_FULL(FoliageType, UFoliageType_InstancedStaticMesh);
	READ_PTR_FULL(StageClass, UClass);
	...
	READ_PTR_FULL(BaseCharacterRef, ABP_BaseCharacter_C);
}

void UBP_MasterFoliage_C::BeforeDelete()
{
	UFoliageInstancedStaticMeshComponent::BeforeDelete();

	DELE_PTR_FULL(ReplaceFoliageType);
	DELE_PTR_FULL(FoliageType);
	DELE_PTR_FULL(StageClass);
	DELE_PTR_FULL(SystemsManagerReference);
	DELE_PTR_FULL(NPC_InteractFemaleMontage);
	DELE_PTR_FULL(NPC_InteractMaleMontage);
	DELE_PTR_FULL(BaseCharacterRef);
}
