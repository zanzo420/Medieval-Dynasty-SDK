...
// BlueprintGeneratedClass BTTask_BanditsGoToCampfire.BTTask_BanditsGoToCampfire_C
// 0x00C8 (FullSize[0x0170] - InheritedSize[0x00A8])
class UBTTask_BanditsGoToCampfire_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_BKLL[0x3];                                     // 0x012D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EM18[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBlackboardKeySelector                      Furniture;                                                 // 0x0138(0x0028) (Edit, BlueprintVisible)
	int                                                CheckSuccess;                                              // 0x0160(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_UGKX[0x4];                                     // 0x0164(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTimerHandle                                FinishTimer;                                               // 0x0168(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_BanditsGoToCampfire.BTTask_BanditsGoToCampfire_C");
		return ptr;
	}



	void OnFail_3469260E4E6FBBA9482D5F91FC23ACEB(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_3469260E4E6FBBA9482D5F91FC23ACEB(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_BanditsGoToCampfire(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
