...
// AnimBlueprintGeneratedClass Young_Pig_AnimBP.Young_Pig_AnimBP_C
// 0x17C4 (FullSize[0x1A7C] - InheritedSize[0x02B8])
class UYoung_Pig_AnimBP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_Y3K7[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_OII9[0x8];                                     // 0x0AB8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LHMG[0x3];                                     // 0x1A31(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RC5H[0x3];                                     // 0x1A39(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	class ABP_HusbandryAI_C*                           Young_Pig;                                                 // 0x1A40(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               DisableIK;                                                 // 0x1A48(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_ALDB[0x3];                                     // 0x1A49(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N08T[0x3];                                     // 0x1A71(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass Young_Pig_AnimBP.Young_Pig_AnimBP_C");
		return ptr;
	}
	...
	void UpdateIKState();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Young_Pig_AnimBP_AnimGraphNode_TransitionResult_CDA88B7A481E8C385842B58BF406CC9E();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Young_Pig_AnimBP_AnimGraphNode_TransitionResult_0C9767E34721DD8D93866F8B382C6BC2();
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void BlueprintBeginPlay();
	void ExecuteUbergraph_Young_Pig_AnimBP(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
