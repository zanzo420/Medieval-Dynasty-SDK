...
// Function DC_HasChildren.DC_HasChildren_C.IsConditionMet
...
bool UDC_HasChildren_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_HasChildren.DC_HasChildren_C.IsConditionMet");

	UDC_HasChildren_C_IsConditionMet_Params params;
...
void UDC_HasChildren_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_HasChildren_C::BeforeDelete()
{
