...
// Function DC_IsKid.DC_IsKid_C.IsConditionMet
...
bool UDC_IsKid_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_IsKid.DC_IsKid_C.IsConditionMet");

	UDC_IsKid_C_IsConditionMet_Params params;
...
void UDC_IsKid_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_IsKid_C::BeforeDelete()
{
