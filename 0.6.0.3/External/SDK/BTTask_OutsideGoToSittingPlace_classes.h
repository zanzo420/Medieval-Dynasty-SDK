...
// BlueprintGeneratedClass BTTask_OutsideGoToSittingPlace.BTTask_OutsideGoToSittingPlace_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_OutsideGoToSittingPlace_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_25ME[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GBUD[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_OutsideGoToSittingPlace.BTTask_OutsideGoToSittingPlace_C");
		return ptr;
	}



	void OnFail_920570BB4868D72A3EF88A98DFAE4DA7(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_920570BB4868D72A3EF88A98DFAE4DA7(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_OutsideGoToSittingPlace(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
