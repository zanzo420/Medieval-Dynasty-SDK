...
// WidgetBlueprintGeneratedClass UI_GoalSlot_TalkToPeople.UI_GoalSlot_TalkToPeople_C
// 0x0068 (FullSize[0x02C8] - InheritedSize[0x0260])
class UUI_GoalSlot_TalkToPeople_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_Q89O[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_TalkToPeople                       Goal;                                                      // 0x0290(0x0030) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalSlot_TalkToPeople.UI_GoalSlot_TalkToPeople_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalSlot_TalkToPeople(int EntryPoint);
