...
void UUI_LabelButton_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Button, UButton);
	READ_PTR_FULL(Icn_LabelIcon, UImage);
	READ_PTR_FULL(Icn_LabelIconBackground, UImage);
	READ_PTR_FULL(txt_LabelName, UTextBlock);
	READ_PTR_FULL(IconToUse, UTexture2D);
}

void UUI_LabelButton_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Button);
	DELE_PTR_FULL(Icn_LabelIcon);
	DELE_PTR_FULL(Icn_LabelIconBackground);
	DELE_PTR_FULL(txt_LabelName);
	DELE_PTR_FULL(IconToUse);
}
