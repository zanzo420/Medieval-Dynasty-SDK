...
// BlueprintGeneratedClass BTTask_GoToSittingPlace.BTTask_GoToSittingPlace_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_GoToSittingPlace_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_J64H[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LJN1[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToSittingPlace.BTTask_GoToSittingPlace_C");
		return ptr;
	}



	void OnFail_013572854CA2274DD3E479A44FBF393B(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_013572854CA2274DD3E479A44FBF393B(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_GoToSittingPlace(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
