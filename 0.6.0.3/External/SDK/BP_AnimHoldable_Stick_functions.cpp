...
void ABP_AnimHoldable_Stick_C::AfterRead()
{
	ABP_MasterAnimHoldable_Static_C::AfterRead();

	READ_PTR_FULL(StaticMesh, UStaticMeshComponent);
	READ_PTR_FULL(FadeTimeline, UTimelineComponent);
	READ_PTR_FULL(DynamicMeatMaterial, UMaterialInstanceDynamic);
}

void ABP_AnimHoldable_Stick_C::BeforeDelete()
{
	ABP_MasterAnimHoldable_Static_C::BeforeDelete();

	DELE_PTR_FULL(StaticMesh);
	DELE_PTR_FULL(FadeTimeline);
	DELE_PTR_FULL(DynamicMeatMaterial);
}
