...
// BlueprintGeneratedClass BP_Calf_Male.BP_Calf_Male_C
// 0x0000 (FullSize[0x0D08] - InheritedSize[0x0D08])
class ABP_Calf_Male_C : public ABP_Bull_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Calf_Male.BP_Calf_Male_C");
		return ptr;
	}
