...
void UUI_WorkplaceSlot_NPCDetails_C::AfterRead()
{
	...
	READ_PTR_FULL(UI_ManagementDetails, UUI_MasterManagementDetails_C);
}

void UUI_WorkplaceSlot_NPCDetails_C::BeforeDelete()
{
	...
	DELE_PTR_FULL(UI_ManagementDetails);
}
