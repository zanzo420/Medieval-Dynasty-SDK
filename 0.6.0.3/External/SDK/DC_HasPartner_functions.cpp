...
// Function DC_HasPartner.DC_HasPartner_C.IsConditionMet
...
bool UDC_HasPartner_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_HasPartner.DC_HasPartner_C.IsConditionMet");

	UDC_HasPartner_C_IsConditionMet_Params params;
...
void UDC_HasPartner_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_HasPartner_C::BeforeDelete()
{
