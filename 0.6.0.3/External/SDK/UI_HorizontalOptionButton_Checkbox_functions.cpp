...
void UUI_HorizontalOptionButton_Checkbox_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Border_7, UBorder);
	READ_PTR_FULL(Button_1, UButton);
	READ_PTR_FULL(CheckBox, UCheckBox);
...
void UUI_HorizontalOptionButton_Checkbox_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Border_7);
	DELE_PTR_FULL(Button_1);
	DELE_PTR_FULL(CheckBox);
