...
void ABP_MasterFurniture_Activity_StaticMesh_C::AfterRead()
{
	ABP_MasterFurniture_Activity_C::AfterRead();

	READ_PTR_FULL(Mesh, UStaticMeshComponent);
}

void ABP_MasterFurniture_Activity_StaticMesh_C::BeforeDelete()
{
	ABP_MasterFurniture_Activity_C::BeforeDelete();
