...
void ABP_NPC_C::AfterRead()
{
	ABP_BaseCharacter_C::AfterRead();

	READ_PTR_FULL(ShadowCaster, USkeletalMeshComponent);
	...
	READ_PTR_FULL(AINPCReference, AAIC_NPC_C);
	READ_PTR_FULL(FieldReference, ABP_MasterField_C);
	READ_PTR_FULL(Building, ABP_MasterBuilding_C);
	READ_PTR_FULL(LastFurniture, ABP_MasterFurniture_C);
	READ_PTR_FULL(WorkMontage, UAnimMontage);
}

void ABP_NPC_C::BeforeDelete()
{
	ABP_BaseCharacter_C::BeforeDelete();

	DELE_PTR_FULL(ShadowCaster);
	DELE_PTR_FULL(ArrowAI);
	DELE_PTR_FULL(BP_BoostComponent);
	DELE_PTR_FULL(NavigationInvoker);
	DELE_PTR_FULL(AINPCReference);
	DELE_PTR_FULL(FieldReference);
	DELE_PTR_FULL(Building);
	DELE_PTR_FULL(LastFurniture);
