...
void ABP_GroundAnimalBase_C::AfterRead()
{
	ABP_AnimalBase_C::AfterRead();

	READ_PTR_FULL(NavigationInvoker, UNavigationInvokerComponent);
	READ_PTR_FULL(Collision_Attack, USphereComponent);
	...
	READ_PTR_FULL(AnimPhysicsBlend, UTimelineComponent);
	READ_PTR_FULL(BTReference, UBehaviorTree);
	READ_PTR_FULL(SensedActor, AActor);
	READ_PTR_FULL(OverlappedActor, AActor);
	READ_PTR_FULL(EngagedActor, AActor);
	READ_PTR_FULL(HomeBase, ABP_AI_POI_Base_C);
	READ_PTR_FULL(mcValidActor, AActor);
	READ_PTR_FULL(NearbyPartner, AActor);
}

void ABP_GroundAnimalBase_C::BeforeDelete()
{
	ABP_AnimalBase_C::BeforeDelete();

	DELE_PTR_FULL(NavigationInvoker);
	DELE_PTR_FULL(Collision_Attack);
	DELE_PTR_FULL(AIPerceptionStimuliSource);
	DELE_PTR_FULL(AIPerception);
	DELE_PTR_FULL(AnimPhysicsBlend);
	DELE_PTR_FULL(BTReference);
	DELE_PTR_FULL(SensedActor);
	DELE_PTR_FULL(OverlappedActor);
	DELE_PTR_FULL(EngagedActor);
	DELE_PTR_FULL(HomeBase);
	DELE_PTR_FULL(mcValidActor);
