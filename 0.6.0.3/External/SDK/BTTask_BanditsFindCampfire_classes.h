...
// BlueprintGeneratedClass BTTask_BanditsFindCampfire.BTTask_BanditsFindCampfire_C
// 0x00B0 (FullSize[0x0158] - InheritedSize[0x00A8])
class UBTTask_BanditsFindCampfire_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_BanditsFindCampfire.BTTask_BanditsFindCampfire_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_BanditsFindCampfire(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
