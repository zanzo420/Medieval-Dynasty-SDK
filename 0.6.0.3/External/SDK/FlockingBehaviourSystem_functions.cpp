...
void FBoidData::AfterRead()
{
}

void FBoidData::BeforeDelete()
{
}

void FOctreeElement::AfterRead()
{
}

void FOctreeElement::BeforeDelete()
{
}

void FFlockSettings::AfterRead()
{
	READ_PTR_FULL(Goal, AGoal);
}

void FFlockSettings::BeforeDelete()
{
	DELE_PTR_FULL(Goal);
}

void FFlockOctreeSettings::AfterRead()
{
	READ_PTR_FULL(OctreeActor, ASpatialPartitioner);
	READ_PTR_FULL(OctTreeClass, UClass);
}

void FFlockOctreeSettings::BeforeDelete()
{
	DELE_PTR_FULL(OctreeActor);
	DELE_PTR_FULL(OctTreeClass);
}

void FBoidFrameSkipSetting::AfterRead()
{
}

void FBoidFrameSkipSetting::BeforeDelete()
{
}

void FBoidMesh_Static::AfterRead()
{
	READ_PTR_FULL(StaticMesh, UStaticMesh);
}

void FBoidMesh_Static::BeforeDelete()
{
	DELE_PTR_FULL(StaticMesh);
}

void FSpawnSettings::AfterRead()
{
	READ_PTR_FULL(ActorToSpawnFrom, AActor);
}

void FSpawnSettings::BeforeDelete()
{
	DELE_PTR_FULL(ActorToSpawnFrom);
}

void FGoalSettings::AfterRead()
{
	READ_PTR_FULL(CustomPointClass, UClass);
}

void FGoalSettings::BeforeDelete()
{
	DELE_PTR_FULL(CustomPointClass);
}

void FFlockDebugElementSetting::AfterRead()
{
}

void FFlockDebugElementSetting::BeforeDelete()
{
}

void FFlockDebugElementSetting_Static::AfterRead()
{
	FFlockDebugElementSetting::AfterRead();

}

void FFlockDebugElementSetting_Static::BeforeDelete()
{
	FFlockDebugElementSetting::BeforeDelete();

}

void FFlockDebugElementSetting_StaticSphere::AfterRead()
{
	FFlockDebugElementSetting_Static::AfterRead();

}

void FFlockDebugElementSetting_StaticSphere::BeforeDelete()
{
	FFlockDebugElementSetting_Static::BeforeDelete();

}

void FFlockDebugElementSetting_StaticBox::AfterRead()
{
	FFlockDebugElementSetting_Static::AfterRead();

}

void FFlockDebugElementSetting_StaticBox::BeforeDelete()
{
	FFlockDebugElementSetting_Static::BeforeDelete();

}

void FFlockDebugElementSetting_Line::AfterRead()
{
	FFlockDebugElementSetting::AfterRead();

}

void FFlockDebugElementSetting_Line::BeforeDelete()
{
	FFlockDebugElementSetting::BeforeDelete();

}

void FFlockDebugSettings::AfterRead()
{
}

void FFlockDebugSettings::BeforeDelete()
{
}

void FDebugVariables_Goal::AfterRead()
{
}

void FDebugVariables_Goal::BeforeDelete()
{
}

void FBoidMesh_Skeletal::AfterRead()
{
	READ_PTR_FULL(SkeletalMesh, USkeletalMesh);
	READ_PTR_FULL(AnimClass, UClass);
}

void FBoidMesh_Skeletal::BeforeDelete()
{
	DELE_PTR_FULL(SkeletalMesh);
	DELE_PTR_FULL(AnimClass);
}

void FBoidSettings::AfterRead()
{
	READ_PTR_FULL(BoidStaticClass, UClass);
	READ_PTR_FULL(BoidSkeletalClass, UClass);
}

void FBoidSettings::BeforeDelete()
{
	DELE_PTR_FULL(BoidStaticClass);
	DELE_PTR_FULL(BoidSkeletalClass);
}

void FFlockOptimizationSettings::AfterRead()
{
}

void FFlockOptimizationSettings::BeforeDelete()
{
}
...
void ABoid::AfterRead()
{
	APawn::AfterRead();

	READ_PTR_FULL(SceneComponent, USceneComponent);
	READ_PTR_FULL(BoidMovementComponent, UBoidMovementComponent);
	READ_PTR_FULL(FlockOwner, AFlock);
	READ_PTR_FULL(Obstacle, AActor);
	READ_PTR_FULL(World, UWorld);
}

void ABoid::BeforeDelete()
{
	APawn::BeforeDelete();

	DELE_PTR_FULL(SceneComponent);
	DELE_PTR_FULL(BoidMovementComponent);
	DELE_PTR_FULL(FlockOwner);
	DELE_PTR_FULL(Obstacle);
	DELE_PTR_FULL(World);
}

void ABoidController::AfterRead()
{
	AController::AfterRead();

}

void ABoidController::BeforeDelete()
{
	AController::BeforeDelete();

}

void UBoidMovementComponent::AfterRead()
{
	UFloatingPawnMovement::AfterRead();

	READ_PTR_FULL(Owner, ABoid);
}

void UBoidMovementComponent::BeforeDelete()
{
...
void UBoidObstacle::AfterRead()
{
	UActorComponent::AfterRead();

}

void UBoidObstacle::BeforeDelete()
{
...
void ABoidSkeletal::BeforeDelete()
{
	ABoid::BeforeDelete();
...
void AFlock::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(SceneComponent, USceneComponent);
	READ_PTR_FULL(BillboardComponent, UBillboardComponent);
	READ_PTR_FULL(SpatialPartitioner, ASpatialPartitioner);
	READ_PTR_FULL(World, UWorld);
}

void AFlock::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(SceneComponent);
	DELE_PTR_FULL(BillboardComponent);
	DELE_PTR_FULL(SpatialPartitioner);
	DELE_PTR_FULL(World);
}
...
void UFlockForce::AfterRead()
{
	UObject::AfterRead();

}

void UFlockForce::BeforeDelete()
{
	UObject::BeforeDelete();

}

void UFlockForce_Align::AfterRead()
{
	UFlockForce::AfterRead();

}

void UFlockForce_Align::BeforeDelete()
{
	UFlockForce::BeforeDelete();

}

void UFlockForce_Cohere::AfterRead()
{
	UFlockForce::AfterRead();

}

void UFlockForce_Cohere::BeforeDelete()
{
	UFlockForce::BeforeDelete();

}

void UFlockForce_Separate::AfterRead()
{
	UFlockForce::AfterRead();

}

void UFlockForce_Separate::BeforeDelete()
{
	UFlockForce::BeforeDelete();

}

void UFlockForce_Custom::AfterRead()
{
	UFlockForce::AfterRead();

}

void UFlockForce_Custom::BeforeDelete()
{
	UFlockForce::BeforeDelete();
...
void AFlockGoalPoint::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(SceneComponent, USceneComponent);
	READ_PTR_FULL(BillboardComponent, UBillboardComponent);
	READ_PTR_FULL(OwningGoal, AGoal);
}

void AFlockGoalPoint::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(SceneComponent);
	DELE_PTR_FULL(BillboardComponent);
	DELE_PTR_FULL(OwningGoal);
}
...
void AGoal::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(SceneComponent, USceneComponent);
	READ_PTR_FULL(BillboardComponent, UBillboardComponent);
	READ_PTR_FULL(Flock, AFlock);
}

void AGoal::BeforeDelete()
{
	AActor::BeforeDelete();
...
void ASpatialPartitioner::AfterRead()
{
	AActor::AfterRead();
...
void ASpatialPartitioner::BeforeDelete()
{
	AActor::BeforeDelete();
