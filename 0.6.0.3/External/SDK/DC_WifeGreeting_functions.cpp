...
// Function DC_WifeGreeting.DC_WifeGreeting_C.IsConditionMet
...
bool UDC_WifeGreeting_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_WifeGreeting.DC_WifeGreeting_C.IsConditionMet");

	UDC_WifeGreeting_C_IsConditionMet_Params params;
...
void UDC_WifeGreeting_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_WifeGreeting_C::BeforeDelete()
{
