...
// BlueprintGeneratedClass BTService_SetHeraldNPCAIState.BTService_SetHeraldNPCAIState_C
// 0x0128 (FullSize[0x01C0] - InheritedSize[0x0098])
class UBTService_SetHeraldNPCAIState_C : public UBTService_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_R1JR[0x3];                                     // 0x0181(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WYWG[0x4];                                     // 0x018C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTService_SetHeraldNPCAIState.BTService_SetHeraldNPCAIState_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTService_SetHeraldNPCAIState(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
