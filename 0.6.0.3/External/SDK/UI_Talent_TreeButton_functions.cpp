...
void UUI_Talent_TreeButton_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Border_2, UBorder);
	READ_PTR_FULL(Button, UButton);
	READ_PTR_FULL(icn_Talent, UImage);
	READ_PTR_FULL(Img_BottomSelection, UImage);
	READ_PTR_FULL(Img_TopSelection, UImage);
	READ_PTR_FULL(TalentLevels, UHorizontalBox);
	READ_PTR_FULL(txt_Level, UTextBlock);
	READ_PTR_FULL(TalentTreeReference, UUI_TalentTree_C);
	READ_PTR_FULL(BorderSelected, UTexture2D);
	READ_PTR_FULL(BorderNormal, UTexture2D);
	READ_PTR_FULL(MaterialReference, UMaterialInstanceDynamic);
}

void UUI_Talent_TreeButton_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Border_2);
	DELE_PTR_FULL(Button);
	DELE_PTR_FULL(icn_Talent);
	DELE_PTR_FULL(Img_BottomSelection);
	DELE_PTR_FULL(Img_TopSelection);
	DELE_PTR_FULL(TalentLevels);
	DELE_PTR_FULL(txt_Level);
	DELE_PTR_FULL(TalentTreeReference);
	DELE_PTR_FULL(BorderSelected);
	DELE_PTR_FULL(BorderNormal);
