...
// WidgetBlueprintGeneratedClass UI_Slot_Description.UI_Slot_Description_C
// 0x0071 (FullSize[0x02D1] - InheritedSize[0x0260])
class UUI_Slot_Description_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_5BF2[0x7];                                     // 0x02B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Slot_Description.UI_Slot_Description_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_Slot_Description(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
