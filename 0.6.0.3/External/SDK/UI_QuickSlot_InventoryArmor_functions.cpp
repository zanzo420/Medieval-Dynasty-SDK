...
void UUI_QuickSlot_InventoryArmor_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Icn_Background, UImage);
	READ_PTR_FULL(img_ItemIcon, UImage);
	READ_PTR_FULL(InventoryComponent, UInventoryComponent_C);
	READ_PTR_FULL(IconForNoItem, UTexture2D);
}

void UUI_QuickSlot_InventoryArmor_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Icn_Background);
	DELE_PTR_FULL(img_ItemIcon);
	DELE_PTR_FULL(InventoryComponent);
	DELE_PTR_FULL(IconForNoItem);
}
