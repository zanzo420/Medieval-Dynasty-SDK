...
void UUI_ShippingDebug_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(DebugTextBlock, UTextBlock);
	READ_PTR_FULL(DebugTextBox, UVerticalBox);
}

void UUI_ShippingDebug_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(DebugTextBlock);
	DELE_PTR_FULL(DebugTextBox);
}
