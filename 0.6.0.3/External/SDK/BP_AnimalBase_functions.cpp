...
void ABP_AnimalBase_C::AfterRead()
{
	ACharacter::AfterRead();

	READ_PTR_FULL(StaminaVoice, UAudioComponent);
	READ_PTR_FULL(BP_AnimalRelationsComponent, UBP_AnimalRelationsComponent_C);
	READ_PTR_FULL(BP_AnimalStatsComponent, UBP_AnimalStatsComponent_C);
	READ_PTR_FULL(BP_BoostComponent, UBP_BoostComponent_C);
	READ_PTR_FULL(BP_AquaticBoyuancy, UBP_AquaticBuoyancy_C);
	READ_PTR_FULL(ArrowAI, UArrowComponent);
	READ_PTR_FULL(SystemsManagerReference, ABP_SystemsManager_C);
	READ_PTR_FULL(DamageCauser, AActor);
	READ_PTR_FULL(InteractAnimationMontageLife, UAnimMontage);
	READ_PTR_FULL(InteractAnimationMontageDead, UAnimMontage);
	READ_PTR_FULL(SpawnLocation, ABP_SpawnPointWildAnimal_C);
	READ_PTR_FULL(InteractedCharacter, ABP_BaseCharacter_C);
	READ_PTR_FULL(GameInstanceReference, UGI_MedievalDynasty_C);
	READ_PTR_FULL(AIControllerRef, AController);
	READ_PTR_FULL(MountBehaviorTree, UBehaviorTree);
}

void ABP_AnimalBase_C::BeforeDelete()
{
	ACharacter::BeforeDelete();

	DELE_PTR_FULL(StaminaVoice);
	DELE_PTR_FULL(BP_AnimalRelationsComponent);
	DELE_PTR_FULL(BP_AnimalStatsComponent);
	DELE_PTR_FULL(BP_BoostComponent);
	DELE_PTR_FULL(BP_AquaticBoyuancy);
	DELE_PTR_FULL(ArrowAI);
	DELE_PTR_FULL(SystemsManagerReference);
	DELE_PTR_FULL(DamageCauser);
	DELE_PTR_FULL(InteractAnimationMontageLife);
	DELE_PTR_FULL(InteractAnimationMontageDead);
	DELE_PTR_FULL(SpawnLocation);
	DELE_PTR_FULL(InteractedCharacter);
	DELE_PTR_FULL(GameInstanceReference);
	DELE_PTR_FULL(AIControllerRef);
	DELE_PTR_FULL(MountBehaviorTree);
}
