...
void ABP_DayNightSystem_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(Arrow, UArrowComponent);
	READ_PTR_FULL(Sun_Root, UArrowComponent);
	READ_PTR_FULL(Ultra_Dynamic_Sky_Sphere, UStaticMeshComponent);
	READ_PTR_FULL(DefaultSceneRoot, USceneComponent);
	READ_PTR_FULL(Direction_Light__Sun_, ADirectionalLight);
	READ_PTR_FULL(Sky_MID, UMaterialInstanceDynamic);
	READ_PTR_FULL(Shine_Intensity_Curve, UCurveFloat);
	READ_PTR_FULL(Cloudy_SunColorCurve, UCurveLinearColor);
	READ_PTR_FULL(Exponential_Height_Fog, AExponentialHeightFog);
	READ_PTR_FULL(Cloudy_CloudLightColorCurve, UCurveLinearColor);
	READ_PTR_FULL(Cloudy_CloudDarkColorCurve, UCurveLinearColor);
	READ_PTR_FULL(Stars_Intensity_Curve, UCurveFloat);
	READ_PTR_FULL(Moon_Position_Curve, UCurveFloat);
	READ_PTR_FULL(Sun_Highlight_Radius_curve, UCurveFloat);
	READ_PTR_FULL(Cloud_Shadows_MID, UMaterialInstanceDynamic);
	READ_PTR_FULL(Moon_Light, ADirectionalLight);
	READ_PTR_FULL(Custom_Moon_Texture, UTexture2D);
	READ_PTR_FULL(SkyLight, ASkyLight);
	READ_PTR_FULL(Night_Filter_Curve, UCurveFloat);
	READ_PTR_FULL(Directional_Intensity_Curve, UCurveFloat);
	READ_PTR_FULL(CloudsBaseTextureReference, UTexture);
	READ_PTR_FULL(SkyLightIntensity, UCurveFloat);
	READ_PTR_FULL(GameInstanceReference, UGI_MedievalDynasty_C);
}

void ABP_DayNightSystem_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(Arrow);
	DELE_PTR_FULL(Sun_Root);
	DELE_PTR_FULL(Ultra_Dynamic_Sky_Sphere);
	DELE_PTR_FULL(DefaultSceneRoot);
	DELE_PTR_FULL(Direction_Light__Sun_);
	DELE_PTR_FULL(Sky_MID);
	DELE_PTR_FULL(Shine_Intensity_Curve);
	DELE_PTR_FULL(Cloudy_SunColorCurve);
	DELE_PTR_FULL(Exponential_Height_Fog);
	DELE_PTR_FULL(Cloudy_CloudLightColorCurve);
	DELE_PTR_FULL(Cloudy_CloudDarkColorCurve);
	DELE_PTR_FULL(Stars_Intensity_Curve);
	DELE_PTR_FULL(Moon_Position_Curve);
	DELE_PTR_FULL(Sun_Highlight_Radius_curve);
	DELE_PTR_FULL(Cloud_Shadows_MID);
	DELE_PTR_FULL(Moon_Light);
	DELE_PTR_FULL(Custom_Moon_Texture);
	DELE_PTR_FULL(SkyLight);
	DELE_PTR_FULL(Night_Filter_Curve);
	DELE_PTR_FULL(Directional_Intensity_Curve);
	DELE_PTR_FULL(CloudsBaseTextureReference);
	DELE_PTR_FULL(SkyLightIntensity);
