...
void UUI_Inspector_Field_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Icon, UImage);
	READ_PTR_FULL(txt_Name, UTextBlock);
	READ_PTR_FULL(Field_Reference, ABP_MasterField_C);
}

void UUI_Inspector_Field_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Icon);
	DELE_PTR_FULL(txt_Name);
	DELE_PTR_FULL(Field_Reference);
}
