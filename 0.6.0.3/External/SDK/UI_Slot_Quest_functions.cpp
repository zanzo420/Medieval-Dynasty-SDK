...
void UUI_Slot_Quest_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Border, UBorder);
	READ_PTR_FULL(btn_QuestSlot, UButton);
	READ_PTR_FULL(icn_QuestTrackingMarker, UImage);
	READ_PTR_FULL(Name, UTextBlock);
	READ_PTR_FULL(UI_HUD_Reference, UUI_HUD_C);
}

void UUI_Slot_Quest_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Border);
	DELE_PTR_FULL(btn_QuestSlot);
	DELE_PTR_FULL(icn_QuestTrackingMarker);
	DELE_PTR_FULL(Name);
