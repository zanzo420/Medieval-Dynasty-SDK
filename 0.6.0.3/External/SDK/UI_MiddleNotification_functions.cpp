...
void UUI_MiddleNotification_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Icn_NotificationImage, UImage);
	READ_PTR_FULL(txt_NotificationHeadline, UTextBlock);
	READ_PTR_FULL(txt_NotificationText, UTextBlock);
	READ_PTR_FULL(Icon, UTexture2D);
}

void UUI_MiddleNotification_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Icn_NotificationImage);
	DELE_PTR_FULL(txt_NotificationHeadline);
	DELE_PTR_FULL(txt_NotificationText);
	DELE_PTR_FULL(Icon);
}
