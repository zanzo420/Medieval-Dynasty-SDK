...
void ABP_MasterProjectile_C::AfterRead()
{
	AActor::AfterRead();
	...
	READ_PTR_FULL(ProjectileMovement, UProjectileMovementComponent);
	READ_PTR_FULL(SC_Hit, USoundBase);
}

void ABP_MasterProjectile_C::BeforeDelete()
{
	AActor::BeforeDelete();
