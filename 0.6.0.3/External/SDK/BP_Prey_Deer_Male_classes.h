...
// BlueprintGeneratedClass BP_Prey_Deer_Male.BP_Prey_Deer_Male_C
// 0x0018 (FullSize[0x0C00] - InheritedSize[0x0BE8])
class ABP_Prey_Deer_Male_C : public ABP_PreyAI_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prey_Deer_Male.BP_Prey_Deer_Male_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Prey_Deer_Male(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
