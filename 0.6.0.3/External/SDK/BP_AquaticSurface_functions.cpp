...
void ABP_AquaticSurface_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(NavModifier, UNavModifierComponent);
	READ_PTR_FULL(Volume, UBoxComponent);
	READ_PTR_FULL(InteractionView, UBoxComponent);
	READ_PTR_FULL(AudioUnderwater, UAudioComponent);
	READ_PTR_FULL(PlaneOverWater, UStaticMeshComponent);
	READ_PTR_FULL(PostProcessShape, UBoxComponent);
	READ_PTR_FULL(Root, USceneComponent);
	READ_PTR_FULL(PostProcessMesh, UStaticMeshComponent);
	READ_PTR_FULL(PostProcess, UPostProcessComponent);
	READ_PTR_FULL(OverWaterMaterial, UMaterialInstance);
	READ_PTR_FULL(VolumeMaterial, UMaterialInstance);
	READ_PTR_FULL(OverWaterMaterialInstance, UMaterialInstanceDynamic);
	READ_PTR_FULL(ReflectionCache, USceneCaptureComponentCube);
	READ_PTR_FULL(VolumeMaterialInstance, UMaterialInstanceDynamic);
	READ_PTR_FULL(AquaticSimulation, ABP_AquaticSimulation_C);
	READ_PTR_FULL(ReflectionPlane, UPlanarReflectionComponent);
	READ_PTR_FULL(PlayerActorReference, AActor);
}

void ABP_AquaticSurface_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(NavModifier);
	DELE_PTR_FULL(Volume);
	DELE_PTR_FULL(InteractionView);
	DELE_PTR_FULL(AudioUnderwater);
	DELE_PTR_FULL(PlaneOverWater);
	DELE_PTR_FULL(PostProcessShape);
	DELE_PTR_FULL(Root);
	DELE_PTR_FULL(PostProcessMesh);
	DELE_PTR_FULL(PostProcess);
	DELE_PTR_FULL(OverWaterMaterial);
	DELE_PTR_FULL(VolumeMaterial);
	DELE_PTR_FULL(OverWaterMaterialInstance);
	DELE_PTR_FULL(ReflectionCache);
	DELE_PTR_FULL(VolumeMaterialInstance);
	DELE_PTR_FULL(AquaticSimulation);
	DELE_PTR_FULL(ReflectionPlane);
	DELE_PTR_FULL(PlayerActorReference);
}
