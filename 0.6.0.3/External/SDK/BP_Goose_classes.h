...
class ABP_Goose_C : public ABP_HusbandryAI_C
{
public:
	unsigned char                                      UnknownData_GDP4[0x7];                                     // 0x0CE1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Goose.BP_Goose_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Goose(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
