...
// BlueprintGeneratedClass BP_BTT_SetRoamBehavior.BP_BTT_SetRoamBehavior_C
// 0x0040 (FullSize[0x00E8] - InheritedSize[0x00A8])
class UBP_BTT_SetRoamBehavior_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BTT_SetRoamBehavior.BP_BTT_SetRoamBehavior_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BTT_SetRoamBehavior(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
