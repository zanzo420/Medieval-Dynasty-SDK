...
class UCow_AnimBP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_KBBU[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_L0BD[0x8];                                     // 0x0D68(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SEF3[0x3];                                     // 0x1CE1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FYYJ[0x2];                                     // 0x1CEA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HB01[0x3];                                     // 0x1CF9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X3HB[0x3];                                     // 0x1D21(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass Cow_AnimBP.Cow_AnimBP_C");
		return ptr;
	}
	...
	void UpdateIKState();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Cow_AnimBP_AnimGraphNode_TransitionResult_3ECB966F4C97798DD0AFB58FE1A7469C();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Cow_AnimBP_AnimGraphNode_TransitionResult_29E2DD3449E4A4489A5AA18F1A11A0C9();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Cow_AnimBP_AnimGraphNode_TransitionResult_20FB8510446A2F75CE324EAC28AEC6F6();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Cow_AnimBP_AnimGraphNode_TransitionResult_C8837F854B1E767238F06095D76848B6();
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void BlueprintBeginPlay();
	void ExecuteUbergraph_Cow_AnimBP(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
