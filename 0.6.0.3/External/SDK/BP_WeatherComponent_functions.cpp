...
void UBP_WeatherComponent_C::AfterRead()
{
	UActorComponent::AfterRead();

	READ_PTR_FULL(PrecipitationFX, UParticleSystemComponent);
	READ_PTR_FULL(Root, UCapsuleComponent);
}

void UBP_WeatherComponent_C::BeforeDelete()
{
	UActorComponent::BeforeDelete();

	DELE_PTR_FULL(PrecipitationFX);
	DELE_PTR_FULL(Root);
}
