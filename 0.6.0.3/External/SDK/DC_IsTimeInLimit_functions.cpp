...
// Function DC_IsTimeInLimit.DC_IsTimeInLimit_C.IsConditionMet
...
bool UDC_IsTimeInLimit_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_IsTimeInLimit.DC_IsTimeInLimit_C.IsConditionMet");

	UDC_IsTimeInLimit_C_IsConditionMet_Params params;
...
void UDC_IsTimeInLimit_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_IsTimeInLimit_C::BeforeDelete()
{
