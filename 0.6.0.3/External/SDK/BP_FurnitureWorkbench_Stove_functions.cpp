...
void ABP_FurnitureWorkbench_Stove_C::AfterRead()
{
	...
	READ_PTR_FULL(Baking, UStaticMeshComponent);
	READ_PTR_FULL(StaticMesh, UStaticMeshComponent);
	READ_PTR_FULL(Firebox_TL, UTimelineComponent);
