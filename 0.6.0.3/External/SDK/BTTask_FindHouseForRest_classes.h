...
// BlueprintGeneratedClass BTTask_FindHouseForRest.BTTask_FindHouseForRest_C
// 0x00D8 (FullSize[0x0180] - InheritedSize[0x00A8])
class UBTTask_FindHouseForRest_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_FindHouseForRest.BTTask_FindHouseForRest_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_FindHouseForRest(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
