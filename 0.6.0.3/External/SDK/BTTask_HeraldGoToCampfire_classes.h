...
// BlueprintGeneratedClass BTTask_HeraldGoToCampfire.BTTask_HeraldGoToCampfire_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_HeraldGoToCampfire_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_A7X4[0x3];                                     // 0x012D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_HeraldGoToCampfire.BTTask_HeraldGoToCampfire_C");
		return ptr;
	}



	void OnFail_D5075ECB4E44C3CFD45976AEAE5E73CD(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_D5075ECB4E44C3CFD45976AEAE5E73CD(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_HeraldGoToCampfire(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
