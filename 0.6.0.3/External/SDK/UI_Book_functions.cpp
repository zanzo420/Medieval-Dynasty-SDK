...
void UUI_Book_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(CanvasPanel_189, UCanvasPanel);
	READ_PTR_FULL(MainBookCanvas, UCanvasPanel);
	READ_PTR_FULL(ScaleBox_69, UScaleBox);
	READ_PTR_FULL(SizeBox_1, USizeBox);
	READ_PTR_FULL(TabSlot, UBorder);
	READ_PTR_FULL(TutorialSlot, UBorder);
	READ_PTR_FULL(UI_AssignToQuickSlotNotification, UUI_AssignToQuickSlotNotification_C);
	READ_PTR_FULL(UI_Book_MainTabs, UUI_Book_MainTabs_C);
	...
	READ_PTR_FULL(MapMaterialInstance, UMaterialInstanceDynamic);
	READ_PTR_FULL(SkillsTabReference, UUI_Book_Skills_C);
	READ_PTR_FULL(QuestTabReference, UUI_Book_Quest_C);
	READ_PTR_FULL(MapTabReference, UUI_Book_Map_C);
	READ_PTR_FULL(ManagementTabReference, UUI_Book_Management_C);
	READ_PTR_FULL(InventoryTabReference, UUI_Book_Inventory_C);
	READ_PTR_FULL(TechnologyTabReference, UUI_Book_Technology_C);
	READ_PTR_FULL(HusbandryAnimalToAssignReference, ABP_HusbandryAI_C);
}

void UUI_Book_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(CanvasPanel_189);
	DELE_PTR_FULL(MainBookCanvas);
	DELE_PTR_FULL(ScaleBox_69);
	DELE_PTR_FULL(SizeBox_1);
	DELE_PTR_FULL(TabSlot);
	DELE_PTR_FULL(TutorialSlot);
	DELE_PTR_FULL(UI_AssignToQuickSlotNotification);
	DELE_PTR_FULL(UI_Book_MainTabs);
	DELE_PTR_FULL(PlayerControllerReference);
	DELE_PTR_FULL(UI_HUD);
	DELE_PTR_FULL(GameModeReference);
	DELE_PTR_FULL(MapMaterialInstance);
	DELE_PTR_FULL(SkillsTabReference);
	DELE_PTR_FULL(QuestTabReference);
	DELE_PTR_FULL(MapTabReference);
	DELE_PTR_FULL(ManagementTabReference);
	DELE_PTR_FULL(InventoryTabReference);
	DELE_PTR_FULL(TechnologyTabReference);
	DELE_PTR_FULL(HusbandryAnimalToAssignReference);
}
