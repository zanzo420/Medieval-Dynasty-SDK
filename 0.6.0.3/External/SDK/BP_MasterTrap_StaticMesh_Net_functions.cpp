...
void ABP_MasterTrap_StaticMesh_Net_C::AfterRead()
{
	ABP_MasterTrap_StaticMesh_C::AfterRead();

	READ_PTR_FULL(Box, UBoxComponent);
}

void ABP_MasterTrap_StaticMesh_Net_C::BeforeDelete()
{
	ABP_MasterTrap_StaticMesh_C::BeforeDelete();
