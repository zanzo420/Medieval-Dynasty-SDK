...
// BlueprintGeneratedClass BTTask_GoToFoliage.BTTask_GoToFoliage_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_GoToFoliage_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_3KSF[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FDF3[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToFoliage.BTTask_GoToFoliage_C");
		return ptr;
	}



	void OnFail_853390BB49368601FC7A3FA73BCC56DC(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_853390BB49368601FC7A3FA73BCC56DC(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ExecuteUbergraph_BTTask_GoToFoliage(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
