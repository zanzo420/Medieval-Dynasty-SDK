...
// BlueprintGeneratedClass AnimalsStep_AnimNotify.AnimalsStep_AnimNotify_C
// 0x001D (FullSize[0x0055] - InheritedSize[0x0038])
class UAnimalsStep_AnimNotify_C : public UAnimNotify
{
public:
	...
	unsigned char                                      UnknownData_YB3N[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AnimalsStep_AnimNotify.AnimalsStep_AnimNotify_C");
		return ptr;
	}
