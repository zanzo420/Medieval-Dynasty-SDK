...
// BlueprintGeneratedClass BP_FurnitureContainer_Barrel.BP_FurnitureContainer_Barrel_C
// 0x0014 (FullSize[0x0498] - InheritedSize[0x0484])
class ABP_FurnitureContainer_Barrel_C : public ABP_MasterFurniture_Container_C
{
public:
	unsigned char                                      UnknownData_VWGC[0x4];                                     // 0x0484(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FurnitureContainer_Barrel.BP_FurnitureContainer_Barrel_C");
		return ptr;
	}
