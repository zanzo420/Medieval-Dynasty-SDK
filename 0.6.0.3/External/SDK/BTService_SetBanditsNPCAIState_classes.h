...
// BlueprintGeneratedClass BTService_SetBanditsNPCAIState.BTService_SetBanditsNPCAIState_C
// 0x0128 (FullSize[0x01C0] - InheritedSize[0x0098])
class UBTService_SetBanditsNPCAIState_C : public UBTService_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_9Q6Q[0x3];                                     // 0x0181(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_988W[0x4];                                     // 0x018C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FBlackboardKeySelector                      Task;                                                      // 0x0198(0x0028) (Edit, BlueprintVisible)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTService_SetBanditsNPCAIState.BTService_SetBanditsNPCAIState_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTService_SetBanditsNPCAIState(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
