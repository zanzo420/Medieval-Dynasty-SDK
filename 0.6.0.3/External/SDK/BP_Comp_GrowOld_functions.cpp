...
void UBP_Comp_GrowOld_C::AfterRead()
{
	UActorComponent::AfterRead();

	READ_PTR_FULL(AdultAnimal, UClass);
	READ_PTR_FULL(ParentRef, ABP_GroundAnimalBase_C);
}

void UBP_Comp_GrowOld_C::BeforeDelete()
{
	UActorComponent::BeforeDelete();

	DELE_PTR_FULL(AdultAnimal);
	DELE_PTR_FULL(ParentRef);
}
