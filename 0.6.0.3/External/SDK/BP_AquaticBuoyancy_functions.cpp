...
void UBP_AquaticBuoyancy_C::AfterRead()
{
	UActorComponent::AfterRead();

	READ_PTR_FULL(CachedMesh, UPrimitiveComponent);
	READ_PTR_FULL(InWater, ABP_AquaticSurface_C);
}

void UBP_AquaticBuoyancy_C::BeforeDelete()
{
	UActorComponent::BeforeDelete();

	DELE_PTR_FULL(CachedMesh);
	DELE_PTR_FULL(InWater);
}
