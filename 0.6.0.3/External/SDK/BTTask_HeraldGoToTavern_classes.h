...
// BlueprintGeneratedClass BTTask_HeraldGoToTavern.BTTask_HeraldGoToTavern_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_HeraldGoToTavern_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_K72X[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P4Q4[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_HeraldGoToTavern.BTTask_HeraldGoToTavern_C");
		return ptr;
	}



	void OnFail_97B9C9A44BA794F2DF89F3B8724552BD(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_97B9C9A44BA794F2DF89F3B8724552BD(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_HeraldGoToTavern(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
