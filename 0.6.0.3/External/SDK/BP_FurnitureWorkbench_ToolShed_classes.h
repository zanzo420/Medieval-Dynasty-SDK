...
// BlueprintGeneratedClass BP_FurnitureWorkbench_ToolShed.BP_FurnitureWorkbench_ToolShed_C
// 0x0010 (FullSize[0x04F8] - InheritedSize[0x04E8])
class ABP_FurnitureWorkbench_ToolShed_C : public ABP_MasterFurniture_Workbench_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FurnitureWorkbench_ToolShed.BP_FurnitureWorkbench_ToolShed_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_FurnitureWorkbench_ToolShed(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
