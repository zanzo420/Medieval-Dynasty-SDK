...
void UUI_Quest_KnowledgeDescription_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Image_305, UImage);
	READ_PTR_FULL(Image_405, UImage);
	READ_PTR_FULL(QuestName, UTextBlock);
	READ_PTR_FULL(TextsBox, UVerticalBox);
	READ_PTR_FULL(txt_KnowledgeDescription, UTextBlock);
	READ_PTR_FULL(UI_Inventory, UUI_Book_C);
}

void UUI_Quest_KnowledgeDescription_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Image_305);
	DELE_PTR_FULL(Image_405);
	DELE_PTR_FULL(QuestName);
	DELE_PTR_FULL(TextsBox);
	DELE_PTR_FULL(txt_KnowledgeDescription);
