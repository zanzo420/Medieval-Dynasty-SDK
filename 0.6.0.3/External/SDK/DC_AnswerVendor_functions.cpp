...
// Function DC_AnswerVendor.DC_AnswerVendor_C.IsConditionMet
...
bool UDC_AnswerVendor_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_AnswerVendor.DC_AnswerVendor_C.IsConditionMet");

	UDC_AnswerVendor_C_IsConditionMet_Params params;
...
void UDC_AnswerVendor_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_AnswerVendor_C::BeforeDelete()
{
