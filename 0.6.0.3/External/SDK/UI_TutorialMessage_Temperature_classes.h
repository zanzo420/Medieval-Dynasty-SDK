...
// WidgetBlueprintGeneratedClass UI_TutorialMessage_Temperature.UI_TutorialMessage_Temperature_C
// 0x003F (FullSize[0x02A0] - InheritedSize[0x0261])
class UUI_TutorialMessage_Temperature_C : public UUI_MasterTutorialMessage_C
{
public:
	unsigned char                                      UnknownData_P2QI[0x7];                                     // 0x0261(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_TutorialMessage_Temperature.UI_TutorialMessage_Temperature_C");
		return ptr;
	}
	...
	void Remove();
	void ExecuteUbergraph_UI_TutorialMessage_Temperature(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
