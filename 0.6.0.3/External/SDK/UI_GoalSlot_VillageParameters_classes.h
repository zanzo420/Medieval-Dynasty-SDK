...
// WidgetBlueprintGeneratedClass UI_GoalSlot_VillageParameters.UI_GoalSlot_VillageParameters_C
// 0x0068 (FullSize[0x02C8] - InheritedSize[0x0260])
class UUI_GoalSlot_VillageParameters_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_0HV6[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_VillageParameters                  Goal;                                                      // 0x0290(0x0038) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalSlot_VillageParameters.UI_GoalSlot_VillageParameters_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalSlot_VillageParameters(int EntryPoint);
