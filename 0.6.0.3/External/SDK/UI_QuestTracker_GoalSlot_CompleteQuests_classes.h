...
// WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_CompleteQuests.UI_QuestTracker_GoalSlot_CompleteQuests_C
// 0x0068 (FullSize[0x02F0] - InheritedSize[0x0288])
class UUI_QuestTracker_GoalSlot_CompleteQuests_C : public UUI_QuestTracker_MasterGoalSlot_C
{
public:
	...
	unsigned char                                      UnknownData_7FCA[0x7];                                     // 0x02C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_CompleteQuests                     Goal;                                                      // 0x02C8(0x0028) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_CompleteQuests.UI_QuestTracker_GoalSlot_CompleteQuests_C");
		return ptr;
	}
	...
	void Remove();
	void Construct();
	void ExecuteUbergraph_UI_QuestTracker_GoalSlot_CompleteQuests(int EntryPoint);
