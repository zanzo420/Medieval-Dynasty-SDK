...
void UUI_Trading_Storage_C::AfterRead()
{
	...
	READ_PTR_FULL(UI_Trading_Storage_ItemCategories, UUI_Trading_Storage_ItemCategories_C);
	READ_PTR_FULL(UI_Trading_Reference, UUI_Trading_C);
}

void UUI_Trading_Storage_C::BeforeDelete()
{
	...
	DELE_PTR_FULL(UI_Trading_Storage_ItemCategories);
