...
// UserDefinedStruct ST_QuestObjective.ST_QuestObjective
// 0x00C8
struct FST_QuestObjective
{
	...
	unsigned char                                      UnknownData_VDDF[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C1QQ[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YCMA[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       DescriptionOnEnd_51_19027AC046558C62449F06A1C2A1E317;      // 0x0060(0x0018) (Edit, BlueprintVisible)
	TEnumAsByte<E_ObjectiveState_E_ObjectiveState>     ObjectiveCompleted_37_660378FA416B5F342424DAA5FD592AC0;    // 0x0078(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                               ChangeObjectiveOnFailed_45_6617F9F44AE26C228A076EB26C256C46; // 0x0079(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_OJ43[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_QuestObjective_OnFailed                 ObjectiveOnFailed_46_3CE952014BF2B56C5269FBA4A76903D9;     // 0x0080(0x0048) (Edit, BlueprintVisible, ContainsInstancedReference, HasGetValueTypeHash)
