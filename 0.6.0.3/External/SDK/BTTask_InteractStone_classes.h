...
// BlueprintGeneratedClass BTTask_InteractStone.BTTask_InteractStone_C
// 0x0060 (FullSize[0x0108] - InheritedSize[0x00A8])
class UBTTask_InteractStone_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_InteractStone.BTTask_InteractStone_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_InteractStone(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
