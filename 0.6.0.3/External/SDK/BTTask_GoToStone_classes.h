...
// BlueprintGeneratedClass BTTask_GoToStone.BTTask_GoToStone_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_GoToStone_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_HN9D[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NNKR[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToStone.BTTask_GoToStone_C");
		return ptr;
	}



	void OnFail_2EF9DDD74D1461F00561A595906E47D3(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_2EF9DDD74D1461F00561A595906E47D3(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_GoToStone(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
