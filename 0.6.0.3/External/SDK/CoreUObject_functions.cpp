...
void UStruct::AfterRead()
{
	...
	READ_PTR_FULL(ChildProperties, FField);
	READ_PTR_FULL(PropertyLink, FProperty);
	READ_PTR_FULL(RefLink, FProperty);
	READ_PTR_FULL(DestructorLink, FProperty);
	READ_PTR_FULL(PostConstructLink, FProperty);
	READ_PTR_FULL(UnresolvedScriptProperties, FUnresolvedScriptPropertiesArray);
	READ_PTR_FULL(UnversionedSchema, FUnversionedStructSchema);
}
...
void UStruct::BeforeDelete()
{
	...
	DELE_PTR_FULL(UnresolvedScriptProperties);
	DELE_PTR_FULL(UnversionedSchema);
}
