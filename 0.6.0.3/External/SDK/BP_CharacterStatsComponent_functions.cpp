...
void UBP_CharacterStatsComponent_C::AfterRead()
{
	UActorComponent::AfterRead();

	READ_PTR_FULL(BaseCharacterReference, ABP_BaseCharacter_C);
	READ_PTR_FULL(LifeStatsSound, UAudioComponent);
	READ_PTR_FULL(RazerChromaSystem, ABP_Chroma_C);
}

void UBP_CharacterStatsComponent_C::BeforeDelete()
{
	UActorComponent::BeforeDelete();

	DELE_PTR_FULL(BaseCharacterReference);
	DELE_PTR_FULL(LifeStatsSound);
	DELE_PTR_FULL(RazerChromaSystem);
}
