...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_NXUW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BPRU[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_GON6[0x3];                                     // 0x0139(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8E7K[0x20];                                    // 0x0140(0x0020) MISSED OFFSET (PADDING)
...
struct FClothParameterMask_Legacy
{
	...
	unsigned char                                      UnknownData_DMST[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NS6Z[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GD33[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
