...
// Function DC_NotWife.DC_NotWife_C.IsConditionMet
...
bool UDC_NotWife_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_NotWife.DC_NotWife_C.IsConditionMet");

	UDC_NotWife_C_IsConditionMet_Params params;
...
void UDC_NotWife_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_NotWife_C::BeforeDelete()
{
