...
// BlueprintGeneratedClass BP_Donkey_Male.BP_Donkey_Male_C
// 0x0130 (FullSize[0x0E11] - InheritedSize[0x0CE1])
class ABP_Donkey_Male_C : public ABP_HusbandryAI_C
{
public:
	unsigned char                                      UnknownData_OC1S[0x7];                                     // 0x0CE1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MRNN[0xC];                                     // 0x0D44(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Donkey_Male.BP_Donkey_Male_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Donkey_Male(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
