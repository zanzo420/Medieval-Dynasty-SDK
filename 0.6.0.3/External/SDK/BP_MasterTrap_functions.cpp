...
void ABP_MasterTrap_C::AfterRead()
{
	ABP_MasterFurniture_C::AfterRead();

	READ_PTR_FULL(CatchSound, USoundBase);
	READ_PTR_FULL(OpenSound, USoundBase);
	READ_PTR_FULL(CloseSound, USoundBase);
}

void ABP_MasterTrap_C::BeforeDelete()
{
	ABP_MasterFurniture_C::BeforeDelete();

	DELE_PTR_FULL(CatchSound);
	DELE_PTR_FULL(OpenSound);
	DELE_PTR_FULL(CloseSound);
}
