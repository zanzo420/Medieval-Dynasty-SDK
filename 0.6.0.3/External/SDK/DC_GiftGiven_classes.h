...
// BlueprintGeneratedClass DC_GiftGiven.DC_GiftGiven_C
// 0x0001 (FullSize[0x0029] - InheritedSize[0x0028])
class UDC_GiftGiven_C : public UDialogueConditions
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DC_GiftGiven.DC_GiftGiven_C");
		return ptr;
	}
