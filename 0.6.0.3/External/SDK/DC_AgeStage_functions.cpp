...
// Function DC_AgeStage.DC_AgeStage_C.IsConditionMet
...
bool UDC_AgeStage_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_AgeStage.DC_AgeStage_C.IsConditionMet");

	UDC_AgeStage_C_IsConditionMet_Params params;
...
void UDC_AgeStage_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_AgeStage_C::BeforeDelete()
{
