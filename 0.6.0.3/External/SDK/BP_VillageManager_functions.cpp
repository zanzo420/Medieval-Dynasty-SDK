...
void ABP_VillageManager_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(ResourceStorageInventory, UInventoryComponent_C);
	READ_PTR_FULL(FoodStorageInventory, UInventoryComponent_C);
	READ_PTR_FULL(DefaultSceneRoot, USceneComponent);
	READ_PTR_FULL(SystemsManagerReference, ABP_SystemsManager_C);
}

void ABP_VillageManager_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(ResourceStorageInventory);
	DELE_PTR_FULL(FoodStorageInventory);
