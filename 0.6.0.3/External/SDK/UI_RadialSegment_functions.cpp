...
void UUI_RadialSegment_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Icon, UImage);
	READ_PTR_FULL(Img_LevelIcon, UImage);
	...
	READ_PTR_FULL(BuildingMenuReference, UUI_BuildingMenu_C);
	READ_PTR_FULL(ModificationMenuReference, UUI_ModuleModificationMenu_C);
	READ_PTR_FULL(FurnitureMenuReference, UUI_Furniture_DecorationMenu_C);
	READ_PTR_FULL(FenceMenuReference, UUI_FenceMenu_C);
}

void UUI_RadialSegment_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Icon);
	DELE_PTR_FULL(Img_LevelIcon);
	DELE_PTR_FULL(LockedIcon);
	DELE_PTR_FULL(Overlay_1);
	DELE_PTR_FULL(CustomIcon);
	DELE_PTR_FULL(HoverSound);
	DELE_PTR_FULL(BuildingMenuReference);
	DELE_PTR_FULL(ModificationMenuReference);
	DELE_PTR_FULL(FurnitureMenuReference);
	DELE_PTR_FULL(FenceMenuReference);
}
