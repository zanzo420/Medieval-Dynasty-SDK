...
struct ABP_FurnitureWorkbench_Anvil_C_GetNPCInteractTime_Params
{
	float                                              Time;                                                      // (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_FurnitureWorkbench_Anvil.BP_FurnitureWorkbench_Anvil_C.GetNPCInteractAnimation
struct ABP_FurnitureWorkbench_Anvil_C_GetNPCInteractAnimation_Params
{
...
struct ABP_FurnitureWorkbench_Anvil_C_GetInteractTool_Params
{
...
struct ABP_FurnitureWorkbench_Anvil_C_FinishFurniture_Params
{
...
struct ABP_FurnitureWorkbench_Anvil_C_ExecuteUbergraph_BP_FurnitureWorkbench_Anvil_Params
{
