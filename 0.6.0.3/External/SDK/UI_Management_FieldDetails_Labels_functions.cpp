...
void UUI_Management_FieldDetails_Labels_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(btn_Crafting, UUI_LabelButton_C);
	READ_PTR_FULL(btn_Overview, UUI_LabelButton_C);
	READ_PTR_FULL(Labels, UHorizontalBox);
	READ_PTR_FULL(UI_Details, UUI_MasterManagementDetails_C);
}

void UUI_Management_FieldDetails_Labels_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(btn_Crafting);
	DELE_PTR_FULL(btn_Overview);
	DELE_PTR_FULL(Labels);
	DELE_PTR_FULL(UI_Details);
}
