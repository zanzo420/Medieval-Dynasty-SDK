...
// BlueprintGeneratedClass BP_FurnitureWorkbench_Smithy.BP_FurnitureWorkbench_Smithy_C
// 0x0010 (FullSize[0x04F8] - InheritedSize[0x04E8])
class ABP_FurnitureWorkbench_Smithy_C : public ABP_MasterFurniture_Workbench_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FurnitureWorkbench_Smithy.BP_FurnitureWorkbench_Smithy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_FurnitureWorkbench_Smithy(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
