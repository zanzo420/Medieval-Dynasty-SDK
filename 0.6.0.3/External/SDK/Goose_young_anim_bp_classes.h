...
// AnimBlueprintGeneratedClass Goose_young_anim_bp.Goose_young_anim_bp_C
// 0x1514 (FullSize[0x17CC] - InheritedSize[0x02B8])
class UGoose_young_anim_bp_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_MEXJ[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_FSGU[0x8];                                     // 0x0808(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1BJC[0x4];                                     // 0x1784(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IWSH[0x2];                                     // 0x1796(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4DFI[0x4];                                     // 0x179C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EDAR[0x3];                                     // 0x17C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass Goose_young_anim_bp.Goose_young_anim_bp_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Goose_young_anim_bp(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
