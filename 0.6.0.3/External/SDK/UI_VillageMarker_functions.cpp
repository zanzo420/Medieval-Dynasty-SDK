...
void UUI_VillageMarker_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Image_39, UImage);
	READ_PTR_FULL(txt_VillageName, UTextBlock);
	READ_PTR_FULL(MarkerReference, AActor);
}

void UUI_VillageMarker_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Image_39);
	DELE_PTR_FULL(txt_VillageName);
