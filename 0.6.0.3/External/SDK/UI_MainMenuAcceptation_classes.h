...
// WidgetBlueprintGeneratedClass UI_MainMenuAcceptation.UI_MainMenuAcceptation_C
// 0x0078 (FullSize[0x02D8] - InheritedSize[0x0260])
class UUI_MainMenuAcceptation_C : public UUserWidget
{
public:
	...
	struct FScriptMulticastDelegate                    AcceptAction;                                              // 0x02C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class UUI_GameMenu_C*                              GameMenuReference;                                         // 0x02D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_MainMenuAcceptation.UI_MainMenuAcceptation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_MainMenuAcceptation(int EntryPoint);
	void AcceptAction__DelegateSignature();
	void AfterRead();
	void BeforeDelete();
