...
// Function DC_GiftAvailable.DC_GiftAvailable_C.IsConditionMet
...
bool UDC_GiftAvailable_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_GiftAvailable.DC_GiftAvailable_C.IsConditionMet");

	UDC_GiftAvailable_C_IsConditionMet_Params params;
...
void UDC_GiftAvailable_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_GiftAvailable_C::BeforeDelete()
{
