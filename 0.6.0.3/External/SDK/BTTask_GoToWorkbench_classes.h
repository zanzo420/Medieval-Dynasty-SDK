...
// BlueprintGeneratedClass BTTask_GoToWorkbench.BTTask_GoToWorkbench_C
// 0x00C0 (FullSize[0x0168] - InheritedSize[0x00A8])
class UBTTask_GoToWorkbench_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_65SN[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HQS8[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBlackboardKeySelector                      Furniture;                                                 // 0x0138(0x0028) (Edit, BlueprintVisible)
	struct FTimerHandle                                FinishTimer;                                               // 0x0160(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToWorkbench.BTTask_GoToWorkbench_C");
		return ptr;
	}



	void OnFail_DA618AB9402EC49DA505A58FA1FFFA32(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_DA618AB9402EC49DA505A58FA1FFFA32(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_GoToWorkbench(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
