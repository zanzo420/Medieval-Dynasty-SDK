...
void ABP_MasterHoldableItem_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(AttachComponent, USceneComponent);
	READ_PTR_FULL(DefaultSceneRoot, USceneComponent);
	READ_PTR_FULL(PlayerCharacterReference, ABP_BaseCharacter_C);
	READ_PTR_FULL(SC_WeaponLoad, USoundBase);
}

void ABP_MasterHoldableItem_C::BeforeDelete()
{
	AActor::BeforeDelete();
