...
void UUI_Dialogue_C::AfterRead()
{
	UDialogueUserWidget::AfterRead();

	READ_PTR_FULL(NewNPCDialogueAnimation, UWidgetAnimation);
	READ_PTR_FULL(AffectionBox, UHorizontalBox);
	READ_PTR_FULL(Img_SelectionIcon_2, UImage);
	READ_PTR_FULL(Img_Speed, UImage);
	READ_PTR_FULL(NextButton, UButton);
	READ_PTR_FULL(NextButtonContainer, UOverlay);
	READ_PTR_FULL(NPCText, UTextBlock);
	READ_PTR_FULL(Number, UTextBlock);
	READ_PTR_FULL(PlayerResponseBox, UScrollBox);
	READ_PTR_FULL(SelectedReplyBackground, UImage);
	READ_PTR_FULL(SizeBox_3, USizeBox);
	READ_PTR_FULL(SpeakerName, UTextBlock);
	READ_PTR_FULL(TextBlock, UTextBlock);
	READ_PTR_FULL(txt_Affection, UTextBlock);
	READ_PTR_FULL(txt_Age, UTextBlock);
	READ_PTR_FULL(txt_Mood, UTextBlock);
	READ_PTR_FULL(txt_Personality, UTextBlock);
	READ_PTR_FULL(InDialogue, UDialogue);
	READ_PTR_FULL(Sound2D, UAudioComponent);
	READ_PTR_FULL(OwningPlayer, APC_Player_C);
	READ_PTR_FULL(tmp_IconForDialogue, UTexture2D);
}

void UUI_Dialogue_C::BeforeDelete()
{
	UDialogueUserWidget::BeforeDelete();

	DELE_PTR_FULL(NewNPCDialogueAnimation);
	DELE_PTR_FULL(AffectionBox);
	DELE_PTR_FULL(Img_SelectionIcon_2);
	DELE_PTR_FULL(Img_Speed);
	DELE_PTR_FULL(NextButton);
	DELE_PTR_FULL(NextButtonContainer);
	DELE_PTR_FULL(NPCText);
	DELE_PTR_FULL(Number);
	DELE_PTR_FULL(PlayerResponseBox);
	DELE_PTR_FULL(SelectedReplyBackground);
	DELE_PTR_FULL(SizeBox_3);
	DELE_PTR_FULL(SpeakerName);
	DELE_PTR_FULL(TextBlock);
	DELE_PTR_FULL(txt_Affection);
	DELE_PTR_FULL(txt_Age);
	DELE_PTR_FULL(txt_Mood);
	DELE_PTR_FULL(txt_Personality);
	DELE_PTR_FULL(InDialogue);
	DELE_PTR_FULL(Sound2D);
	DELE_PTR_FULL(OwningPlayer);
	DELE_PTR_FULL(tmp_IconForDialogue);
}
