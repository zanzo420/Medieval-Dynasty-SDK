...
void ABP_MasterItem_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(InspectorPoint, USphereComponent);
	READ_PTR_FULL(AquaticBoyuancy, UBP_AquaticBuoyancy_C);
	READ_PTR_FULL(UI_Inspector, UWidgetComponent);
	READ_PTR_FULL(StaticMesh, UStaticMeshComponent);
	READ_PTR_FULL(AquaticInteraction, UBP_AquaticInteraction_C);
	READ_PTR_FULL(CharacterReference, APawn);
	READ_PTR_FULL(InteractingActorReference, ABP_BaseCharacter_C);
	READ_PTR_FULL(UI_InspectorReference, UUI_Inspector_Item_C);
}

void ABP_MasterItem_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(InspectorPoint);
	DELE_PTR_FULL(AquaticBoyuancy);
	DELE_PTR_FULL(UI_Inspector);
	DELE_PTR_FULL(StaticMesh);
	DELE_PTR_FULL(AquaticInteraction);
	DELE_PTR_FULL(CharacterReference);
	DELE_PTR_FULL(InteractingActorReference);
