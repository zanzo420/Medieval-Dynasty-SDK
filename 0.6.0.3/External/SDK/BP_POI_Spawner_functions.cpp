...
void ABP_POI_Spawner_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(DebugIcon, UBillboardComponent);
	READ_PTR_FULL(TextRender, UTextRenderComponent);
	READ_PTR_FULL(SpawnPointsDummy, UBillboardComponent);
	READ_PTR_FULL(SpawnerSphere, USphereComponent);
	READ_PTR_FULL(DefaultSceneRoot, USceneComponent);
}

void ABP_POI_Spawner_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(DebugIcon);
	DELE_PTR_FULL(TextRender);
	DELE_PTR_FULL(SpawnPointsDummy);
	DELE_PTR_FULL(SpawnerSphere);
