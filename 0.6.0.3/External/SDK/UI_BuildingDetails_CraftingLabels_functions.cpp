...
void UUI_BuildingDetails_CraftingLabels_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(txt_OneDay, UTextBlock);
}

void UUI_BuildingDetails_CraftingLabels_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(txt_OneDay);
}
