...
void ABP_MasterSplineStructure_C::AfterRead()
{
	AActor::AfterRead();
	...
	READ_PTR_FULL(BuildingGhostMaterialReference, UMaterialInstanceDynamic);
}

void ABP_MasterSplineStructure_C::BeforeDelete()
{
	AActor::BeforeDelete();
	...
	DELE_PTR_FULL(BuildingGhostMaterialReference);
}
