...
// BlueprintGeneratedClass DE_Recruit_WithLove.DE_Recruit_WithLove_C
// 0x0020 (FullSize[0x0048] - InheritedSize[0x0028])
class UDE_Recruit_WithLove_C : public UDialogueEvents
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass DE_Recruit_WithLove.DE_Recruit_WithLove_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_DE_Recruit_WithLove(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
