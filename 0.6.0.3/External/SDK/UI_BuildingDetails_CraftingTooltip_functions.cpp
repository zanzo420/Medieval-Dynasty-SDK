...
void UUI_BuildingDetails_CraftingTooltip_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(CostBox, UHorizontalBox);
	READ_PTR_FULL(CraftingResources, UUniformGridPanel);
