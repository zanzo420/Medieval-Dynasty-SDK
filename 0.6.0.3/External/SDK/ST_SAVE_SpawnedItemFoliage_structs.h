...
struct FST_SAVE_SpawnedItemFoliage
{
	...
	unsigned char                                      UnknownData_BIJD[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      Owner_16_E5D125A24FC21ED1AF7BEEB26E3C06E4;                 // 0x0040(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
