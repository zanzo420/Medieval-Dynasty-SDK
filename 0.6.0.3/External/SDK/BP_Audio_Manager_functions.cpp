...
void ABP_Audio_Manager_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(Ambient_3, UAudioComponent);
	READ_PTR_FULL(Ambient_2, UAudioComponent);
	READ_PTR_FULL(Billboard, UBillboardComponent);
	READ_PTR_FULL(TimeBeforeNewSong, UTimelineComponent);
	READ_PTR_FULL(ExplorationTimeOfDayBlend, UTimelineComponent);
	READ_PTR_FULL(CombatMusicBlend, UTimelineComponent);
	READ_PTR_FULL(AudioAreaReference, ABP_Audio_Area_C);
	READ_PTR_FULL(MostRelevantAudioArea, ABP_Audio_Area_C);
	READ_PTR_FULL(Music_Sound_2, UAudioComponent);
	READ_PTR_FULL(Music_Sound_3, UAudioComponent);
	READ_PTR_FULL(CombatSwitchStinger, USoundCue);
	READ_PTR_FULL(MusicSwitchStinger, USoundCue);
	READ_PTR_FULL(RandomAmbientAttenuation, USoundAttenuation);
	READ_PTR_FULL(SystemsManagerReference, ABP_SystemsManager_C);
}

void ABP_Audio_Manager_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(Ambient_3);
	DELE_PTR_FULL(Ambient_2);
	DELE_PTR_FULL(Billboard);
	DELE_PTR_FULL(TimeBeforeNewSong);
	DELE_PTR_FULL(ExplorationTimeOfDayBlend);
	DELE_PTR_FULL(CombatMusicBlend);
	DELE_PTR_FULL(AudioAreaReference);
	DELE_PTR_FULL(MostRelevantAudioArea);
	DELE_PTR_FULL(Music_Sound_2);
	DELE_PTR_FULL(Music_Sound_3);
	DELE_PTR_FULL(CombatSwitchStinger);
	DELE_PTR_FULL(MusicSwitchStinger);
	DELE_PTR_FULL(RandomAmbientAttenuation);
