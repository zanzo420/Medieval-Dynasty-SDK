...
bool UDC_CustomText_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_CustomText.DC_CustomText_C.IsConditionMet");

	UDC_CustomText_C_IsConditionMet_Params params;
...
void UDC_CustomText_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_CustomText_C::BeforeDelete()
{
