...
void ABP_PlayerManager_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(DefaultSceneRoot, USceneComponent);
	READ_PTR_FULL(InspectorIntensity, UTimelineComponent);
	READ_PTR_FULL(SystemsManagerReference, ABP_SystemsManager_C);
	READ_PTR_FULL(PlayerControllerReference, APC_Player_C);
	READ_PTR_FULL(FearSphere, USphereComponent);
	READ_PTR_FULL(PlayerMountReference, ABP_AnimalBase_C);
}

void ABP_PlayerManager_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(DefaultSceneRoot);
	DELE_PTR_FULL(InspectorIntensity);
	DELE_PTR_FULL(SystemsManagerReference);
	DELE_PTR_FULL(PlayerControllerReference);
	DELE_PTR_FULL(FearSphere);
	DELE_PTR_FULL(PlayerMountReference);
}
