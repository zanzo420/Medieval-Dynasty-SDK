...
void UUI_Field_SeedTypeSlot_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Button_119, UButton);
	READ_PTR_FULL(Image_95, UImage);
	READ_PTR_FULL(txt_seedName, UTextBlock);
	READ_PTR_FULL(ParentWidget, UUI_ManagementDetails_Field_C);
	READ_PTR_FULL(SeedIcon, UTexture2D);
	READ_PTR_FULL(SeedIconForSelection, UTexture2D);
}

void UUI_Field_SeedTypeSlot_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Button_119);
	DELE_PTR_FULL(Image_95);
	DELE_PTR_FULL(txt_seedName);
	DELE_PTR_FULL(ParentWidget);
	DELE_PTR_FULL(SeedIcon);
	DELE_PTR_FULL(SeedIconForSelection);
}
