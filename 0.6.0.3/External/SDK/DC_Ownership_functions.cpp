...
// Function DC_Ownership.DC_Ownership_C.IsConditionMet
...
bool UDC_Ownership_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_Ownership.DC_Ownership_C.IsConditionMet");

	UDC_Ownership_C_IsConditionMet_Params params;
...
void UDC_Ownership_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_Ownership_C::BeforeDelete()
{
