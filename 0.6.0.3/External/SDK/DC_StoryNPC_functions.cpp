...
// Function DC_StoryNPC.DC_StoryNPC_C.IsConditionMet
...
bool UDC_StoryNPC_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_StoryNPC.DC_StoryNPC_C.IsConditionMet");

	UDC_StoryNPC_C_IsConditionMet_Params params;
...
void UDC_StoryNPC_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_StoryNPC_C::BeforeDelete()
{
