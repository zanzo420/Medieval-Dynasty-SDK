...
// Function DC_HeirGreeting.DC_HeirGreeting_C.IsConditionMet
...
bool UDC_HeirGreeting_C::IsConditionMet(class APlayerController* ConsideringPlayer, class AActor* NPCActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function DC_HeirGreeting.DC_HeirGreeting_C.IsConditionMet");

	UDC_HeirGreeting_C_IsConditionMet_Params params;
...
void UDC_HeirGreeting_C::AfterRead()
{
	UDialogueConditions::AfterRead();

}

void UDC_HeirGreeting_C::BeforeDelete()
{
