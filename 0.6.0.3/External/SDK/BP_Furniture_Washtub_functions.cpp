...
void ABP_Furniture_Washtub_C::AfterRead()
{
	ABP_Furniture_RefillableContainer_C::AfterRead();

	READ_PTR_FULL(ObstructionMesh, USphereComponent);
	READ_PTR_FULL(water, USkeletalMeshComponent);
	READ_PTR_FULL(Mesh, UStaticMeshComponent);
	READ_PTR_FULL(FillWashtubAnimRef, UWashtub_AnimBP_C);
}

void ABP_Furniture_Washtub_C::BeforeDelete()
{
	...
	DELE_PTR_FULL(water);
	DELE_PTR_FULL(Mesh);
	DELE_PTR_FULL(FillWashtubAnimRef);
}
