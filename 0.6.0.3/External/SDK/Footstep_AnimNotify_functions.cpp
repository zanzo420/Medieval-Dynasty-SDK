...
{
	static auto fn = UObject::FindObject<UFunction>("Function Footstep_AnimNotify.Footstep_AnimNotify_C.Received_Notify");
...
void UFootstep_AnimNotify_C::AfterRead()
{
...
void UFootstep_AnimNotify_C::BeforeDelete()
{
