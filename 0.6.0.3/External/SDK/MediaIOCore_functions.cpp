...
void FMediaCaptureOptions::AfterRead()
{
}

void FMediaCaptureOptions::BeforeDelete()
{
}

void FMediaIODevice::AfterRead()
{
}

void FMediaIODevice::BeforeDelete()
{
}

void FMediaIOMode::AfterRead()
{
}

void FMediaIOMode::BeforeDelete()
{
}

void FMediaIOConnection::AfterRead()
{
}

void FMediaIOConnection::BeforeDelete()
{
}

void FMediaIOConfiguration::AfterRead()
{
}

void FMediaIOConfiguration::BeforeDelete()
{
}

void FMediaIOOutputConfiguration::AfterRead()
{
}

void FMediaIOOutputConfiguration::BeforeDelete()
{
}

void FMediaIOInputConfiguration::AfterRead()
{
}

void FMediaIOInputConfiguration::BeforeDelete()
{
}
...
void UMediaCapture::AfterRead()
{
	UObject::AfterRead();

	READ_PTR_FULL(MediaOutput, UMediaOutput);
	READ_PTR_FULL(CapturingRenderTarget, UTextureRenderTarget2D);
}

void UMediaCapture::BeforeDelete()
{
	UObject::BeforeDelete();

	DELE_PTR_FULL(MediaOutput);
	DELE_PTR_FULL(CapturingRenderTarget);
}

void UFileMediaCapture::AfterRead()
{
	UMediaCapture::AfterRead();

}

void UFileMediaCapture::BeforeDelete()
{
	UMediaCapture::BeforeDelete();
...
void UMediaOutput::AfterRead()
{
	UObject::AfterRead();

}

void UMediaOutput::BeforeDelete()
{
	UObject::BeforeDelete();

}

void UFileMediaOutput::AfterRead()
{
	UMediaOutput::AfterRead();

}

void UFileMediaOutput::BeforeDelete()
{
	UMediaOutput::BeforeDelete();
