...
// AnimBlueprintGeneratedClass YoungSheep_AnimBP.YoungSheep_AnimBP_C
// 0x1A7C (FullSize[0x1D34] - InheritedSize[0x02B8])
class UYoungSheep_AnimBP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_O7L5[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_DP80[0x8];                                     // 0x0D68(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HBZV[0x3];                                     // 0x1CE1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RIEZ[0x6];                                     // 0x1CEA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MHW9[0x3];                                     // 0x1CFD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8T5X[0x4];                                     // 0x1D04(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9TSQ[0x3];                                     // 0x1D29(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass YoungSheep_AnimBP.YoungSheep_AnimBP_C");
		return ptr;
	}
	...
	void UpdateIKState();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_YoungSheep_AnimBP_AnimGraphNode_TransitionResult_2167748F4C637422F79C1BB52BB21698();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_YoungSheep_AnimBP_AnimGraphNode_TransitionResult_D38F59FF4C05A18C8B859FBBDEF033BF();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_YoungSheep_AnimBP_AnimGraphNode_TransitionResult_25FF38AA4C19FB296ACD76B7F9EEFE20();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_YoungSheep_AnimBP_AnimGraphNode_TransitionResult_929CFB114746914DCCA930AA4799DFC3();
	void BlueprintBeginPlay();
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void ExecuteUbergraph_YoungSheep_AnimBP(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
