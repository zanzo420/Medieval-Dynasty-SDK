...
// WidgetBlueprintGeneratedClass UI_AssignToQuickSlotNotification.UI_AssignToQuickSlotNotification_C
// 0x0020 (FullSize[0x0280] - InheritedSize[0x0260])
class UUI_AssignToQuickSlotNotification_C : public UUserWidget
{
public:
	...
	class UImage*                                      Image_287;                                                 // 0x0278(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_AssignToQuickSlotNotification.UI_AssignToQuickSlotNotification_C");
		return ptr;
	}
