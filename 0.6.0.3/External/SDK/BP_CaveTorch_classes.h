...
// BlueprintGeneratedClass BP_CaveTorch.BP_CaveTorch_C
// 0x0028 (FullSize[0x0248] - InheritedSize[0x0220])
class ABP_CaveTorch_C : public AActor
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0220(0x0008) (ZeroConstructor, Transient, DuplicateTransient, UObjectWrapper)
	class UParticleSystemComponent*                    Fire;                                                      // 0x0228(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CaveTorch.BP_CaveTorch_C");
		return ptr;
	}
	...
	void EnableTorch();
	void DisableTorch();
	void ExecuteUbergraph_BP_CaveTorch(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
