...
// BlueprintGeneratedClass BTTask_FindWildAnimal.BTTask_FindWildAnimal_C
// 0x0128 (FullSize[0x01D0] - InheritedSize[0x00A8])
class UBTTask_FindWildAnimal_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_FindWildAnimal.BTTask_FindWildAnimal_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_FindWildAnimal(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
