...
struct UBTTask_NPCTalking_C_ReceiveExecuteAI_Params
{
...
struct UBTTask_NPCTalking_C_CanTalk_Params
{
};

// Function BTTask_NPCTalking.BTTask_NPCTalking_C.ReceiveTickAI
struct UBTTask_NPCTalking_C_ReceiveTickAI_Params
{
	class AAIController*                               OwnerController;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APawn*                                       ControlledPawn;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBTTask_NPCTalking_C_ReceiveAbortAI_Params
{
	class AAIController*                               OwnerController;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APawn*                                       ControlledPawn;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UBTTask_NPCTalking_C_EndTalk_Params
{
};

// Function BTTask_NPCTalking.BTTask_NPCTalking_C.ExecuteUbergraph_BTTask_NPCTalking
struct UBTTask_NPCTalking_C_ExecuteUbergraph_BTTask_NPCTalking_Params
{
