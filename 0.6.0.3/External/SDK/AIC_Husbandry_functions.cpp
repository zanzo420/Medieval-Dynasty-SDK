...
void AAIC_Husbandry_C::GetPrice_Sell(int* Price)
{
...
// Parameters:
// int                            Price                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
void AAIC_Husbandry_C::GetPrice_Buy(int* Price)
{
...
void AAIC_Husbandry_C::GetInventoryComponent(class UInventoryComponent_C** InventoryComponent)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.GetInventoryComponent");

	AAIC_Husbandry_C_GetInventoryComponent_Params params;
...
void AAIC_Husbandry_C::GetSystemManager(class ABP_SystemsManager_C** SystemManager)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.GetSystemManager");

	AAIC_Husbandry_C_GetSystemManager_Params params;
...
void AAIC_Husbandry_C::CheckIsBuilding(const struct FVector& CheckLocation, const struct FVector& Destination, struct FVector* NewLocation)
{
...
void AAIC_Husbandry_C::GetFear(int* FearFactor)
{
...
void AAIC_Husbandry_C::GetAnimal(class ABP_AnimalBase_C** AnimalBase)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.GetAnimal");

	AAIC_Husbandry_C_GetAnimal_Params params;
...
void AAIC_Husbandry_C::Remove()
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.Remove");

	AAIC_Husbandry_C_Remove_Params params;
...
void AAIC_Husbandry_C::CheckDistance(const struct FVector& PlayerLocation)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.CheckDistance");

	AAIC_Husbandry_C_CheckDistance_Params params;
...
void AAIC_Husbandry_C::SetFear(int Fear)
{
...
// (Public, BlueprintCallable, BlueprintEvent)
void AAIC_Husbandry_C::OnWakeUp()
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.OnWakeUp");

	AAIC_Husbandry_C_OnWakeUp_Params params;
...
void AAIC_Husbandry_C::Starving(float HungerDamage)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.Starving");

	AAIC_Husbandry_C_Starving_Params params;
...
// (Public, BlueprintCallable, BlueprintEvent)
void AAIC_Husbandry_C::OnSleep()
{
	static auto fn = UObject::FindObject<UFunction>("Function AIC_Husbandry.AIC_Husbandry_C.OnSleep");

	AAIC_Husbandry_C_OnSleep_Params params;
...
void AAIC_Husbandry_C::SetAnimalMovementMode_BPI(TEnumAsByte<E_MovementMode_E_MovementMode> MovementMode)
{
...
void AAIC_Husbandry_C::UpdateMountEquipment(bool Unequip, const struct FST_ItemOutfit& ItemData)
{
...
void AAIC_Husbandry_C::ExecuteUbergraph_AIC_Husbandry(int EntryPoint)
{
...
void AAIC_Husbandry_C::AfterRead()
{
	ADetourCrowdAIController::AfterRead();

}

void AAIC_Husbandry_C::BeforeDelete()
{
	ADetourCrowdAIController::BeforeDelete();
