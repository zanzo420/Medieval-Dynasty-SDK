...
void ABP_FlowmapRiverSystem_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(Icon, UBillboardComponent);
	READ_PTR_FULL(RiverSplineComponent, USplineComponent);
	READ_PTR_FULL(RiverMaterial, UMaterialInterface);
	READ_PTR_FULL(RiverMaterial_LOD, UMaterialInterface);
	READ_PTR_FULL(Sound, UAudioComponent);
}

void ABP_FlowmapRiverSystem_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(Icon);
	DELE_PTR_FULL(RiverSplineComponent);
	DELE_PTR_FULL(RiverMaterial);
	DELE_PTR_FULL(RiverMaterial_LOD);
	DELE_PTR_FULL(Sound);
}
