...
void ABP_BaseCharacter_C::AfterRead()
{
	ACharacter::AfterRead();

	READ_PTR_FULL(BP_CombatComponent, UBP_CombatComponent_C);
	READ_PTR_FULL(MountRider, UMountRiderComponent);
	READ_PTR_FULL(Pouch, USkeletalMeshComponent);
	READ_PTR_FULL(Backpack, USkeletalMeshComponent);
	READ_PTR_FULL(UI_Inspector, UWidgetComponent);
	READ_PTR_FULL(Voice, UAudioComponent);
	READ_PTR_FULL(Hair, USkeletalMeshComponent);
	READ_PTR_FULL(BP_AquaticInteractionRightFoot, UBP_AquaticInteraction_C);
	READ_PTR_FULL(BP_AquaticInteraction, UBP_AquaticInteraction_C);
	READ_PTR_FULL(BP_AquaticInteractionRightHand, UBP_AquaticInteraction_C);
	READ_PTR_FULL(BP_AquaticInteractionLeftHand, UBP_AquaticInteraction_C);
	READ_PTR_FULL(BP_AquaticBuoyancy, UBP_AquaticBuoyancy_C);
	READ_PTR_FULL(BP_AquaticInteractionLeftFoot, UBP_AquaticInteraction_C);
	READ_PTR_FULL(BP_StageInteractionComponent, UBP_StageInteractionComponent_C);
	READ_PTR_FULL(HatSKM, USkeletalMeshComponent);
	READ_PTR_FULL(Hood, USkeletalMeshComponent);
	...
	READ_PTR_FULL(BP_CharacterStatsComponent, UBP_CharacterStatsComponent_C);
	READ_PTR_FULL(BP_RelationsComponent, UBP_CharacterRelationsComponent_C);
	READ_PTR_FULL(InventoryComponent, UInventoryComponent_C);
	READ_PTR_FULL(AIPerceptionStimuliSource, UAIPerceptionStimuliSourceComponent);
	READ_PTR_FULL(EyesStateTL, UTimelineComponent);
	READ_PTR_FULL(Blinking, UTimelineComponent);
	READ_PTR_FULL(FistFightingTimeline, UTimelineComponent);
	READ_PTR_FULL(HeldItem, ABP_MasterHoldableItem_C);
	READ_PTR_FULL(ContainerReference, ABP_MasterFurniture_Container_C);
	READ_PTR_FULL(WorkbenchReference, ABP_MasterFurniture_Workbench_C);
	READ_PTR_FULL(Off_HandItem, ABP_MasterHoldableItem_C);
	READ_PTR_FULL(SystemsManagerReference, ABP_SystemsManager_C);
	READ_PTR_FULL(InteractedAnimal, ABP_AnimalBase_C);
	READ_PTR_FULL(BuildingReference, ABP_MasterBuilding_C);
	READ_PTR_FULL(CurrentPickingMontage, UAnimMontage);
	READ_PTR_FULL(LeftHandReference, ABP_MasterHoldableItem_C);
	READ_PTR_FULL(RightHandReference, ABP_MasterHoldableItem_C);
	READ_PTR_FULL(UI_InspectorReference, UUI_Inspector_NPC_C);
	READ_PTR_FULL(InteractedActor, AActor);
}

void ABP_BaseCharacter_C::BeforeDelete()
{
	ACharacter::BeforeDelete();

	DELE_PTR_FULL(BP_CombatComponent);
	DELE_PTR_FULL(MountRider);
	DELE_PTR_FULL(Pouch);
	DELE_PTR_FULL(Backpack);
	DELE_PTR_FULL(UI_Inspector);
	DELE_PTR_FULL(Voice);
	DELE_PTR_FULL(Hair);
	DELE_PTR_FULL(BP_AquaticInteractionRightFoot);
	DELE_PTR_FULL(BP_AquaticInteraction);
	DELE_PTR_FULL(BP_AquaticInteractionRightHand);
	DELE_PTR_FULL(BP_AquaticInteractionLeftHand);
	DELE_PTR_FULL(BP_AquaticBuoyancy);
	DELE_PTR_FULL(BP_AquaticInteractionLeftFoot);
	DELE_PTR_FULL(BP_StageInteractionComponent);
	DELE_PTR_FULL(HatSKM);
	DELE_PTR_FULL(Hood);
	DELE_PTR_FULL(Torso);
	DELE_PTR_FULL(Feet);
	DELE_PTR_FULL(Legs);
	DELE_PTR_FULL(Hands);
	DELE_PTR_FULL(BP_CharacterStatsComponent);
	DELE_PTR_FULL(BP_RelationsComponent);
	DELE_PTR_FULL(InventoryComponent);
	DELE_PTR_FULL(AIPerceptionStimuliSource);
	DELE_PTR_FULL(EyesStateTL);
	DELE_PTR_FULL(Blinking);
	DELE_PTR_FULL(FistFightingTimeline);
	DELE_PTR_FULL(HeldItem);
	DELE_PTR_FULL(ContainerReference);
	DELE_PTR_FULL(WorkbenchReference);
	DELE_PTR_FULL(Off_HandItem);
	DELE_PTR_FULL(SystemsManagerReference);
	DELE_PTR_FULL(InteractedAnimal);
	DELE_PTR_FULL(BuildingReference);
	DELE_PTR_FULL(CurrentPickingMontage);
	DELE_PTR_FULL(LeftHandReference);
	DELE_PTR_FULL(RightHandReference);
