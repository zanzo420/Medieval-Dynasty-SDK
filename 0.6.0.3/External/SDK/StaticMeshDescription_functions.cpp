...
void FUVMapSettings::AfterRead()
{
}

void FUVMapSettings::BeforeDelete()
{
}
...
void UStaticMeshDescription::AfterRead()
{
	UMeshDescriptionBase::AfterRead();

}

void UStaticMeshDescription::BeforeDelete()
{
	UMeshDescriptionBase::BeforeDelete();
