...
void ABP_HusbandryAI_C::AfterRead()
{
	ABP_GroundAnimalBase_C::AfterRead();

	READ_PTR_FULL(MountablePawn, UMountablePawnComponent);
	READ_PTR_FULL(RotationResetTL, UTimelineComponent);
	READ_PTR_FULL(HomeBasePrey, ABP_AI_POI_Base_C);
	READ_PTR_FULL(MountSpeedCurve, UCurveFloat);
	READ_PTR_FULL(SpringArm, USpringArmComponent);
	READ_PTR_FULL(Camera, UCameraComponent);
	READ_PTR_FULL(PlayerReference, ABP_PlayerCharacter_C);
	READ_PTR_FULL(SummonFinishedCue, USoundCue);
	READ_PTR_FULL(MountJumpMontage, UAnimMontage);
	READ_PTR_FULL(MountStopMontage, UAnimMontage);
}

void ABP_HusbandryAI_C::BeforeDelete()
{
	ABP_GroundAnimalBase_C::BeforeDelete();

	DELE_PTR_FULL(MountablePawn);
	DELE_PTR_FULL(RotationResetTL);
	DELE_PTR_FULL(HomeBasePrey);
	DELE_PTR_FULL(MountSpeedCurve);
	DELE_PTR_FULL(SpringArm);
	DELE_PTR_FULL(Camera);
	DELE_PTR_FULL(PlayerReference);
	DELE_PTR_FULL(SummonFinishedCue);
	DELE_PTR_FULL(MountJumpMontage);
