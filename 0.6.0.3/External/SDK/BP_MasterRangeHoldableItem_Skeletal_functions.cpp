...
void ABP_MasterRangeHoldableItem_Skeletal_C::AfterRead()
{
	ABP_MasterRangeHoldableItem_C::AfterRead();

	READ_PTR_FULL(SkeletalMesh, USkeletalMeshComponent);
}

void ABP_MasterRangeHoldableItem_Skeletal_C::BeforeDelete()
{
	ABP_MasterRangeHoldableItem_C::BeforeDelete();
