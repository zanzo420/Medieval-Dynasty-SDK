...
// BlueprintGeneratedClass BTTask_GoToWorkPlace.BTTask_GoToWorkPlace_C
// 0x00E8 (FullSize[0x0190] - InheritedSize[0x00A8])
class UBTTask_GoToWorkPlace_C : public UBTTask_BlueprintBase
{
public:
	...
	struct FBlackboardKeySelector                      Task;                                                      // 0x00C0(0x0028) (Edit, BlueprintVisible)
	struct FBlackboardKeySelector                      WorkTask;                                                  // 0x00E8(0x0028) (Edit, BlueprintVisible)
	...
	unsigned char                                      UnknownData_VGQP[0x3];                                     // 0x0179(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TKXS[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToWorkPlace.BTTask_GoToWorkPlace_C");
		return ptr;
	}



	void OnFail_14C3BD034E1C077E2326BA9A5E72E153(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_14C3BD034E1C077E2326BA9A5E72E153(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_GoToWorkPlace(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
