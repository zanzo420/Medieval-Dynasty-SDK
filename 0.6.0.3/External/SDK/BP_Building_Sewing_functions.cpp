...
void ABP_Building_Sewing_C::AfterRead()
{
	ABP_MasterBuilding_C::AfterRead();

	READ_PTR_FULL(TailoringTableSocket, UArrowComponent);
	READ_PTR_FULL(S_Building_Stairs_B, UStaticMeshComponent);
	READ_PTR_FULL(LoomSocket, UArrowComponent);
	READ_PTR_FULL(ChestSocket, UArrowComponent);
	READ_PTR_FULL(SpinninWheelsSocket, UArrowComponent);
}

void ABP_Building_Sewing_C::BeforeDelete()
{
	ABP_MasterBuilding_C::BeforeDelete();

	DELE_PTR_FULL(TailoringTableSocket);
	DELE_PTR_FULL(S_Building_Stairs_B);
	DELE_PTR_FULL(LoomSocket);
	DELE_PTR_FULL(ChestSocket);
	DELE_PTR_FULL(SpinninWheelsSocket);
}
