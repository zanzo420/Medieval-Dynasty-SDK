...
// BlueprintGeneratedClass BP_Prey_Deer_Male_Young.BP_Prey_Deer_Male_Young_C
// 0x0020 (FullSize[0x0C08] - InheritedSize[0x0BE8])
class ABP_Prey_Deer_Male_Young_C : public ABP_PreyAI_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Prey_Deer_Male_Young.BP_Prey_Deer_Male_Young_C");
		return ptr;
	}
	...
	void EventDead();
	void ExecuteUbergraph_BP_Prey_Deer_Male_Young(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
