...
void ABP_Orchard_C::AfterRead()
{
	ABP_MasterField_C::AfterRead();

	READ_PTR_FULL(Mesh_Hop_Stage25, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Hop_Stage3, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Hop_Stage2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Hop_Stage1, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Hop_Stage0, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cherry_Stage35, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cherry_Stage25, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Pear_Stage35, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Pear_Stage25, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Plum_Stage35, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Plum_Stage25, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Apple_Stage35, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Apple_Stage25, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cherry_Stage3, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cherry_Stage2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cherry_Stage1, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Cherry_Stage0, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Pear_Stage3, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Pear_Stage2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Pear_Stage1, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Pear_Stage0, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Plum_Stage3, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Plum_Stage2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Plum_Stage1, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Plum_Stage0, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Apple_Stage3, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Apple_Stage2, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Apple_Stage1, UHierarchicalInstancedStaticMeshComponent);
	READ_PTR_FULL(Mesh_Apple_Stage0, UHierarchicalInstancedStaticMeshComponent);
}

void ABP_Orchard_C::BeforeDelete()
{
	ABP_MasterField_C::BeforeDelete();

	DELE_PTR_FULL(Mesh_Hop_Stage25);
	DELE_PTR_FULL(Mesh_Hop_Stage3);
	DELE_PTR_FULL(Mesh_Hop_Stage2);
	DELE_PTR_FULL(Mesh_Hop_Stage1);
	DELE_PTR_FULL(Mesh_Hop_Stage0);
	DELE_PTR_FULL(Mesh_Cherry_Stage35);
	DELE_PTR_FULL(Mesh_Cherry_Stage25);
	DELE_PTR_FULL(Mesh_Pear_Stage35);
	DELE_PTR_FULL(Mesh_Pear_Stage25);
	DELE_PTR_FULL(Mesh_Plum_Stage35);
	DELE_PTR_FULL(Mesh_Plum_Stage25);
	DELE_PTR_FULL(Mesh_Apple_Stage35);
	DELE_PTR_FULL(Mesh_Apple_Stage25);
	DELE_PTR_FULL(Mesh_Cherry_Stage3);
	DELE_PTR_FULL(Mesh_Cherry_Stage2);
	DELE_PTR_FULL(Mesh_Cherry_Stage1);
	DELE_PTR_FULL(Mesh_Cherry_Stage0);
	DELE_PTR_FULL(Mesh_Pear_Stage3);
	DELE_PTR_FULL(Mesh_Pear_Stage2);
	DELE_PTR_FULL(Mesh_Pear_Stage1);
	DELE_PTR_FULL(Mesh_Pear_Stage0);
	DELE_PTR_FULL(Mesh_Plum_Stage3);
	DELE_PTR_FULL(Mesh_Plum_Stage2);
	DELE_PTR_FULL(Mesh_Plum_Stage1);
	DELE_PTR_FULL(Mesh_Plum_Stage0);
	DELE_PTR_FULL(Mesh_Apple_Stage3);
	DELE_PTR_FULL(Mesh_Apple_Stage2);
	DELE_PTR_FULL(Mesh_Apple_Stage1);
	DELE_PTR_FULL(Mesh_Apple_Stage0);
}
