...
// BlueprintGeneratedClass BTTask_OutsideGoToCampfire.BTTask_OutsideGoToCampfire_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_OutsideGoToCampfire_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_43NG[0x3];                                     // 0x012D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_OutsideGoToCampfire.BTTask_OutsideGoToCampfire_C");
		return ptr;
	}



	void OnFail_D254CEB340ECD50BA470C2924CAE3CE5(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_D254CEB340ECD50BA470C2924CAE3CE5(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_OutsideGoToCampfire(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
