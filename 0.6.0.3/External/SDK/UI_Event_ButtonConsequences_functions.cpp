...
void UUI_Event_ButtonConsequences_C::AfterRead()
{
	UUserWidget::AfterRead();

	READ_PTR_FULL(Image_180, UImage);
	READ_PTR_FULL(TextSwitcher, UWidgetSwitcher);
	READ_PTR_FULL(txt_ItemName_Long, UTextBlock);
	READ_PTR_FULL(txt_ItemName_Short, UTextBlock);
	READ_PTR_FULL(Image, UObject);
}

void UUI_Event_ButtonConsequences_C::BeforeDelete()
{
	UUserWidget::BeforeDelete();

	DELE_PTR_FULL(Image_180);
	DELE_PTR_FULL(TextSwitcher);
	DELE_PTR_FULL(txt_ItemName_Long);
	DELE_PTR_FULL(txt_ItemName_Short);
	DELE_PTR_FULL(Image);
}
