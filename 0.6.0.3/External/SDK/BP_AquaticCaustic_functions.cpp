...
void ABP_AquaticCaustic_C::AfterRead()
{
	ADecalActor::AfterRead();

	READ_PTR_FULL(StaticMesh, UStaticMeshComponent);
	READ_PTR_FULL(Plane, UStaticMeshComponent);
	READ_PTR_FULL(SunDirection, UArrowComponent);
	READ_PTR_FULL(MaterialInstance, UMaterialInstanceDynamic);
	READ_PTR_FULL(LightSource, ADirectionalLight);
	READ_PTR_FULL(DynamicMaterial, UMaterialInterface);
}

void ABP_AquaticCaustic_C::BeforeDelete()
{
	ADecalActor::BeforeDelete();

	DELE_PTR_FULL(StaticMesh);
	DELE_PTR_FULL(Plane);
	DELE_PTR_FULL(SunDirection);
	DELE_PTR_FULL(MaterialInstance);
	DELE_PTR_FULL(LightSource);
