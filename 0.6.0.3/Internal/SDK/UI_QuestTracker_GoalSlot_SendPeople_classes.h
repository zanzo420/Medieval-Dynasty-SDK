...
// WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_SendPeople.UI_QuestTracker_GoalSlot_SendPeople_C
// 0x0060 (FullSize[0x02E8] - InheritedSize[0x0288])
class UUI_QuestTracker_GoalSlot_SendPeople_C : public UUI_QuestTracker_MasterGoalSlot_C
{
public:
	...
	unsigned char                                      UnknownData_9QVR[0x7];                                     // 0x02C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_SendPeopleToKing                   Goal;                                                      // 0x02C8(0x0020) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_SendPeople.UI_QuestTracker_GoalSlot_SendPeople_C");
		return ptr;
	}
	...
	void Remove();
	void Construct();
	void ExecuteUbergraph_UI_QuestTracker_GoalSlot_SendPeople(int EntryPoint);
