...
struct ABP_Trap_FishingNetSmall_C_Catch_Params
{
	bool                                               Load;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function BP_Trap_FishingNetSmall.BP_Trap_FishingNetSmall_C.PickUpAnimal
struct ABP_Trap_FishingNetSmall_C_PickUpAnimal_Params
{
...
struct ABP_Trap_FishingNetSmall_C_ExecuteUbergraph_BP_Trap_FishingNetSmall_Params
{
