...
// BlueprintGeneratedClass BTTask_HeraldFindCampfire.BTTask_HeraldFindCampfire_C
// 0x00B0 (FullSize[0x0158] - InheritedSize[0x00A8])
class UBTTask_HeraldFindCampfire_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_HeraldFindCampfire.BTTask_HeraldFindCampfire_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_HeraldFindCampfire(int EntryPoint);
};
