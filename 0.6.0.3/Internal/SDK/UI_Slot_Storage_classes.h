...
// WidgetBlueprintGeneratedClass UI_Slot_Storage.UI_Slot_Storage_C
// 0x021D (FullSize[0x047D] - InheritedSize[0x0260])
class UUI_Slot_Storage_C : public UUserWidget
{
public:
	...
	class UImage*                                      Icn_ItemBackgroun;                                         // 0x0290(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_FY93[0x3];                                     // 0x02C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8ZG8[0x6];                                     // 0x02CA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	int                                                ArrayIndex;                                                // 0x0478(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                               AlmostBroken;                                              // 0x047C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Slot_Storage.UI_Slot_Storage_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_Slot_Storage(int EntryPoint);
};
