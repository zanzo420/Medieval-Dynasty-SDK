...
// BlueprintGeneratedClass BTTask_GoToField.BTTask_GoToField_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_GoToField_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_IWEM[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_45HV[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToField.BTTask_GoToField_C");
		return ptr;
	}



	void OnFail_73E1FEC5429096EA082C3390BFDB5F8E(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_73E1FEC5429096EA082C3390BFDB5F8E(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_GoToField(int EntryPoint);
};
