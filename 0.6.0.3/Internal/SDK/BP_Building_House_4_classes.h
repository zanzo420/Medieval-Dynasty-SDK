...
// BlueprintGeneratedClass BP_Building_House_4.BP_Building_House_3_C
// 0x0008 (FullSize[0x0760] - InheritedSize[0x0758])
class ABP_Building_House_3_C : public ABP_MasterBuilding_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Building_House_4.BP_Building_House_3_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Building_House_4(int EntryPoint);
};
