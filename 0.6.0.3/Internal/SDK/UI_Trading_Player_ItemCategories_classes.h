...
// WidgetBlueprintGeneratedClass UI_Trading_Player_ItemCategories.UI_Trading_Player_ItemCategories_C
// 0x0010 (FullSize[0x02B8] - InheritedSize[0x02A8])
class UUI_Trading_Player_ItemCategories_C : public UUI_MasterLabels_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Trading_Player_ItemCategories.UI_Trading_Player_ItemCategories_C");
		return ptr;
	}
	...
	void MiscHovered();
	void ExecuteUbergraph_UI_Trading_Player_ItemCategories(int EntryPoint);
};
