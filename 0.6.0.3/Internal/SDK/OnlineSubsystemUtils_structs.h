...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_0EQK[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_U7OU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_NM9T[0x108];                                   // 0x0000(0x0108) MISSED OFFSET (PADDING)
...
struct FOnlineProxyStoreOffer
{
	...
	unsigned char                                      UnknownData_UEDN[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OD7H[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RIEA[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductInfo2
{
	...
	unsigned char                                      UnknownData_SSJF[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest2
{
	...
	unsigned char                                      UnknownData_VHYR[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
