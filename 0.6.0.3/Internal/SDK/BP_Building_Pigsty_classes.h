...
// BlueprintGeneratedClass BP_Building_Pigsty.BP_Building_Pigsty_C
// 0x0010 (FullSize[0x0768] - InheritedSize[0x0758])
class ABP_Building_Pigsty_C : public ABP_MasterBuilding_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Building_Pigsty.BP_Building_Pigsty_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Building_Pigsty(int EntryPoint);
};
