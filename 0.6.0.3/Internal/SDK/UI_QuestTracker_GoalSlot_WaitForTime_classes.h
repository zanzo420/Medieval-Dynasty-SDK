...
// WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_WaitForTime.UI_QuestTracker_GoalSlot_WaitForTime_C
// 0x0080 (FullSize[0x0308] - InheritedSize[0x0288])
class UUI_QuestTracker_GoalSlot_WaitForTime_C : public UUI_QuestTracker_MasterGoalSlot_C
{
public:
	...
	unsigned char                                      UnknownData_KZEX[0x7];                                     // 0x02C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_WaitForTimes                       Goal;                                                      // 0x02C8(0x0040) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_WaitForTime.UI_QuestTracker_GoalSlot_WaitForTime_C");
		return ptr;
	}
	...
	void Remove();
	void Construct();
	void ExecuteUbergraph_UI_QuestTracker_GoalSlot_WaitForTime(int EntryPoint);
