...
enum class ChromaSDKPlugin_EChromaSDKMouseLed : uint8_t
{
...
enum class ChromaSDKPlugin_EChromaSDKKeyboardKey : uint8_t
{
...
enum class ChromaSDKPlugin_EChromaSDKDeviceEnum : uint8_t
{
...
enum class ChromaSDKPlugin_EChromaSDKDevice2DEnum : uint8_t
{
...
enum class ChromaSDKPlugin_EChromaSDKDevice1DEnum : uint8_t
{
...
enum class ChromaSDKPlugin_EChromaSDKDeviceTypeEnum : uint8_t
{
	EChromaSDKDeviceTypeEnum__DE_1D = 0,
	EChromaSDKDeviceTypeEnum__DE_2D = 1,
	EChromaSDKDeviceTypeEnum__DE_MAX = 2,
...
struct FChromaSDKColorFrame1D
{
	...
	unsigned char                                      UnknownData_PTOV[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FChromaSDKColorFrame2D
{
	...
	unsigned char                                      UnknownData_ASYP[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D3EP[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
