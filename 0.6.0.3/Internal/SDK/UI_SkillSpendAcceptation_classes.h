...
// WidgetBlueprintGeneratedClass UI_SkillSpendAcceptation.UI_SkillSpendAcceptation_C
// 0x0088 (FullSize[0x02E8] - InheritedSize[0x0260])
class UUI_SkillSpendAcceptation_C : public UUserWidget
{
public:
	...
	struct FScriptMulticastDelegate                    ActionDispatcher;                                          // 0x02D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class UUI_Book_Skills_C*                           UI_SkillsReference;                                        // 0x02E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_SkillSpendAcceptation.UI_SkillSpendAcceptation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_SkillSpendAcceptation(int EntryPoint);
