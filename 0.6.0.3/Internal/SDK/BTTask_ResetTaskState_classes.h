...
// BlueprintGeneratedClass BTTask_ResetTaskState.BTTask_ResetTaskState_C
// 0x0088 (FullSize[0x0130] - InheritedSize[0x00A8])
class UBTTask_ResetTaskState_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_ResetTaskState.BTTask_ResetTaskState_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_ResetTaskState(int EntryPoint);
};
