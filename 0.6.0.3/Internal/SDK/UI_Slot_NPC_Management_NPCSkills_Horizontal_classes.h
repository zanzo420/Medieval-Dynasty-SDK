...
// WidgetBlueprintGeneratedClass UI_Slot_NPC_Management_NPCSkills_Horizontal.UI_Slot_NPC_Management_NPCSkills_Horizontal_C
// 0x0021 (FullSize[0x0281] - InheritedSize[0x0260])
class UUI_Slot_NPC_Management_NPCSkills_Horizontal_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_PH70[0x3];                                     // 0x0279(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Slot_NPC_Management_NPCSkills_Horizontal.UI_Slot_NPC_Management_NPCSkills_Horizontal_C");
		return ptr;
	}
	...
	void MakeActive();
	void MakeUnactive();
	void ExecuteUbergraph_UI_Slot_NPC_Management_NPCSkills_Horizontal(int EntryPoint);
};
