...
// WidgetBlueprintGeneratedClass UI_GoalSlot_ConvincePeople.UI_GoalSlot_ConvincePeople_C
// 0x0058 (FullSize[0x02B8] - InheritedSize[0x0260])
class UUI_GoalSlot_ConvincePeople_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_FCID[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_ConvincePeople                     Goal;                                                      // 0x0290(0x0020) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalSlot_ConvincePeople.UI_GoalSlot_ConvincePeople_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalSlot_ConvincePeople(int EntryPoint);
