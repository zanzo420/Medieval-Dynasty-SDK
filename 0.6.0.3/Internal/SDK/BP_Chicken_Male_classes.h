...
// BlueprintGeneratedClass BP_Chicken_Male.BP_Chicken_Male_C
// 0x000F (FullSize[0x0CF0] - InheritedSize[0x0CE1])
class ABP_Chicken_Male_C : public ABP_HusbandryAI_C
{
public:
	unsigned char                                      UnknownData_KRO1[0x7];                                     // 0x0CE1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Chicken_Male.BP_Chicken_Male_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Chicken_Male(int EntryPoint);
};
