...
// WidgetBlueprintGeneratedClass UI_Orchard_Info_Slot.UI_Orchard_Info_Slot_C
// 0x0138 (FullSize[0x0398] - InheritedSize[0x0260])
class UUI_Orchard_Info_Slot_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Orchard_Info_Slot.UI_Orchard_Info_Slot_C");
		return ptr;
	}
	...
	void BndEvt__Button_72_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature();
	...
	void ExecuteUbergraph_UI_Orchard_Info_Slot(int EntryPoint);
};
