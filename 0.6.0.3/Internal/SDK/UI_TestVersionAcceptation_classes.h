...
// WidgetBlueprintGeneratedClass UI_TestVersionAcceptation.UI_TestVersionAcceptation_C
// 0x0038 (FullSize[0x0298] - InheritedSize[0x0260])
class UUI_TestVersionAcceptation_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_TestVersionAcceptation.UI_TestVersionAcceptation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_TestVersionAcceptation(int EntryPoint);
};
