...
struct FARSessionPayload
{
	...
	unsigned char                                      UnknownData_IY8O[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARPlaneUpdatePayload
{
	...
	unsigned char                                      UnknownData_172C[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LDGZ[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PJ0I[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FARFaceUpdatePayload
{
	...
	unsigned char                                      UnknownData_CZT2[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_KAFH[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4LOC[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_85L9[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_SABT[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_Z9WE[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_98O8[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_9JUW[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARSkeletonDefinition
{
	...
	unsigned char                                      UnknownData_BJWX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARPose3D
{
	...
	unsigned char                                      UnknownData_BGEG[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FARTraceResult
{
	...
	unsigned char                                      UnknownData_J4HQ[0xB];                                     // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6U2G[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
...
struct FARSessionStatus
{
	...
	unsigned char                                      UnknownData_2L21[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
