...
// BlueprintGeneratedClass BTTask_GoToAnimals.BTTask_GoToAnimals_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_GoToAnimals_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_3ZM2[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QJQ4[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToAnimals.BTTask_GoToAnimals_C");
		return ptr;
	}



	void OnFail_372F52FC4993058C2B108A8C194EBF92(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_372F52FC4993058C2B108A8C194EBF92(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_GoToAnimals(int EntryPoint);
};
