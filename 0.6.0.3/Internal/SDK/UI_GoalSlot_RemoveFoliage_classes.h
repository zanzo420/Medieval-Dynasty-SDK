...
// WidgetBlueprintGeneratedClass UI_GoalSlot_RemoveFoliage.UI_GoalSlot_RemoveFoliage_C
// 0x0068 (FullSize[0x02C8] - InheritedSize[0x0260])
class UUI_GoalSlot_RemoveFoliage_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_8MFE[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_RemoveFoliage                      Goal;                                                      // 0x0290(0x0030) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	class APC_Player_C*                                PlayerControllerReference;                                 // 0x02C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalSlot_RemoveFoliage.UI_GoalSlot_RemoveFoliage_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalSlot_RemoveFoliage(int EntryPoint);
