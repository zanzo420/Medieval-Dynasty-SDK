...
// BlueprintGeneratedClass BP_LynxAI.BP_LynxAI_C
// 0x0019 (FullSize[0x0BE9] - InheritedSize[0x0BD0])
class ABP_LynxAI_C : public ABP_GroundAnimalBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_LynxAI.BP_LynxAI_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_LynxAI(int EntryPoint);
};
