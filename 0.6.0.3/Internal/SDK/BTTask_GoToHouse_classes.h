...
// BlueprintGeneratedClass BTTask_GoToHouse.BTTask_GoToHouse_C
// 0x0098 (FullSize[0x0140] - InheritedSize[0x00A8])
class UBTTask_GoToHouse_C : public UBTTask_BlueprintBase
{
public:
	...
	unsigned char                                      UnknownData_6YDF[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QNHY[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_GoToHouse.BTTask_GoToHouse_C");
		return ptr;
	}



	void OnFail_0EBD7B534FE895F63E39EE85EE58DAD3(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void OnSuccess_0EBD7B534FE895F63E39EE85EE58DAD3(TEnumAsByte<AIModule_EPathFollowingResult> MovementResult);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void Finish();
	void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTTask_GoToHouse(int EntryPoint);
};
