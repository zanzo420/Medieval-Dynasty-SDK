...
// BlueprintGeneratedClass BTTask_SetNPCBehavior.BTTask_SetNPCBehavior_C
// 0x0060 (FullSize[0x0108] - InheritedSize[0x00A8])
class UBTTask_SetNPCBehavior_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_SetNPCBehavior.BTTask_SetNPCBehavior_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_SetNPCBehavior(int EntryPoint);
};
