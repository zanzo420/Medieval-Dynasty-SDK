...
{
	unsigned char                                      UnknownData_VC6P[0xAC];                                    // 0x0000(0x00AC) MISSED OFFSET (PADDING)
...
struct FBehaviorInfo
{
	...
	unsigned char                                      UnknownData_ZEYZ[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveGizmo
{
	unsigned char                                      UnknownData_0HYV[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FInputRayHit
{
	unsigned char                                      UnknownData_7ZOY[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
