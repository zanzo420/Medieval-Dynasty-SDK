...
// BlueprintGeneratedClass BP_FurnitureWorkbench_JuicePress.BP_FurnitureWorkbench_JuicePress_C
// 0x0018 (FullSize[0x0500] - InheritedSize[0x04E8])
class ABP_FurnitureWorkbench_JuicePress_C : public ABP_MasterFurniture_Workbench_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FurnitureWorkbench_JuicePress.BP_FurnitureWorkbench_JuicePress_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_FurnitureWorkbench_JuicePress(int EntryPoint);
};
