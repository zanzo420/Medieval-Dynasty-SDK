...
// WidgetBlueprintGeneratedClass UI_GoalSlot_WaitForTime.UI_GoalSlot_WaitForTime_C
// 0x0070 (FullSize[0x02D0] - InheritedSize[0x0260])
class UUI_GoalSlot_WaitForTime_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_FON4[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_WaitForTimes                       Goal;                                                      // 0x0290(0x0040) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalSlot_WaitForTime.UI_GoalSlot_WaitForTime_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalSlot_WaitForTime(int EntryPoint);
