...
// BlueprintGeneratedClass BTTask_HeraldFindActivityTavern.BTTask_HeraldFindActivityTavern_C
// 0x00B0 (FullSize[0x0158] - InheritedSize[0x00A8])
class UBTTask_HeraldFindActivityTavern_C : public UBTTask_BlueprintBase
{
public:
	...
	struct FBlackboardKeySelector                      Task;                                                      // 0x0130(0x0028) (Edit, BlueprintVisible)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_HeraldFindActivityTavern.BTTask_HeraldFindActivityTavern_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_HeraldFindActivityTavern(int EntryPoint);
};
