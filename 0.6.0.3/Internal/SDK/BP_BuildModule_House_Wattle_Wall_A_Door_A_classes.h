...
// BlueprintGeneratedClass BP_BuildModule_House_Wattle_Wall_A_Door_A.BP_BuildModule_House_Wattle_Wall_A_Door_A_C
// 0x003C (FullSize[0x0450] - InheritedSize[0x0414])
class ABP_BuildModule_House_Wattle_Wall_A_Door_A_C : public ABP_MasterBuildModule_C
{
public:
	unsigned char                                      UnknownData_6OMZ[0x4];                                     // 0x0414(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BuildModule_House_Wattle_Wall_A_Door_A.BP_BuildModule_House_Wattle_Wall_A_Door_A_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BuildModule_House_Wattle_Wall_A_Door_A(int EntryPoint);
};
