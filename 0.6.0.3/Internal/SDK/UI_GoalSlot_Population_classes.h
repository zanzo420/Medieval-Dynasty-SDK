...
// WidgetBlueprintGeneratedClass UI_GoalSlot_Population.UI_GoalSlot_Population_C
// 0x0058 (FullSize[0x02B8] - InheritedSize[0x0260])
class UUI_GoalSlot_Population_C : public UUserWidget
{
public:
	...
	unsigned char                                      UnknownData_6B93[0x7];                                     // 0x0289(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_Population                         Goal;                                                      // 0x0290(0x0028) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalSlot_Population.UI_GoalSlot_Population_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalSlot_Population(int EntryPoint);
