...
// BlueprintGeneratedClass BP_Building_ResourceStorage.BP_Building_ResourceStorage_C
// 0x0018 (FullSize[0x0770] - InheritedSize[0x0758])
class ABP_Building_ResourceStorage_C : public ABP_MasterBuilding_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0758(0x0008) (ZeroConstructor, Transient, DuplicateTransient, UObjectWrapper)
	class UStaticMeshComponent*                        S_Building_Stairs_C;                                       // 0x0760(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Building_ResourceStorage.BP_Building_ResourceStorage_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Building_ResourceStorage(int EntryPoint);
};
