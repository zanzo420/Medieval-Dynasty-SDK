...
struct ABP_Lamb_Male_C_GetInteractAction_Params
{
...
struct ABP_Lamb_Male_C_IsInteractable_Params
{
...
struct ABP_Lamb_Male_C_Interact_Params
{
	class ABP_BaseCharacter_C*                         BaseCharacter;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_Lamb_Male_C_ExecuteUbergraph_BP_Lamb_Male_Params
{
