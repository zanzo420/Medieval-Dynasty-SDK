...
struct FInputChord
{
	...
	unsigned char                                      UnknownData_36PR[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomizedToolMenuEntry
{
	...
	unsigned char                                      UnknownData_DBVD[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	Slate_ECustomizedToolMenuVisibility                Visibility;                                                // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_D5DN[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FCustomizedToolMenu
{
	...
	unsigned char                                      UnknownData_7BEV[0xE0];                                    // 0x0108(0x00E0) MISSED OFFSET (PADDING)
