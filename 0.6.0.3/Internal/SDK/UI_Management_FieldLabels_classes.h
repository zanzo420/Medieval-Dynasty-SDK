...
// WidgetBlueprintGeneratedClass UI_Management_FieldLabels.UI_Management_FieldLabels_C
// 0x0070 (FullSize[0x02D0] - InheritedSize[0x0260])
class UUI_Management_FieldLabels_C : public UUserWidget
{
public:
	...
	class UImage*                                      Image_11;                                                  // 0x02B0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                      Image_12;                                                  // 0x02B8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Management_FieldLabels.UI_Management_FieldLabels_C");
		return ptr;
	}
