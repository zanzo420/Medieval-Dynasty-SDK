...
// BlueprintGeneratedClass BTTask_FindActivityTavern.BTTask_FindActivityTavern_C
// 0x00B0 (FullSize[0x0158] - InheritedSize[0x00A8])
class UBTTask_FindActivityTavern_C : public UBTTask_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_FindActivityTavern.BTTask_FindActivityTavern_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_FindActivityTavern(int EntryPoint);
};
