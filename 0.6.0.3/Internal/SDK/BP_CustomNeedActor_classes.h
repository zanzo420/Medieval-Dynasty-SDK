...
// BlueprintGeneratedClass BP_CustomNeedActor.BP_CustomNeedActor_C
// 0x003E (FullSize[0x025E] - InheritedSize[0x0220])
class ABP_CustomNeedActor_C : public AActor
{
public:
	...
	class UStaticMeshComponent*                        Marker;                                                    // 0x0238(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	bool                                               MarketHidden;                                              // 0x025D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CustomNeedActor.BP_CustomNeedActor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CustomNeedActor(int EntryPoint);
};
