...
// WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_TalentPointsToSpend.UI_QuestTracker_GoalSlot_TalentPointsToSpend_C
// 0x0044 (FullSize[0x02CC] - InheritedSize[0x0288])
class UUI_QuestTracker_GoalSlot_TalentPointsToSpend_C : public UUI_QuestTracker_MasterGoalSlot_C
{
public:
	...
	unsigned char                                      UnknownData_YBL3[0x3];                                     // 0x02C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_SpendTalentPoints                  Goal;                                                      // 0x02C4(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_TalentPointsToSpend.UI_QuestTracker_GoalSlot_TalentPointsToSpend_C");
		return ptr;
	}
	...
	void Remove();
	void Construct();
	void ExecuteUbergraph_UI_QuestTracker_GoalSlot_TalentPointsToSpend(int EntryPoint);
