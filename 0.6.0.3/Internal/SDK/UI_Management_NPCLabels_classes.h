...
// WidgetBlueprintGeneratedClass UI_Management_NPCLabels.UI_Management_NPCLabels_C
// 0x0048 (FullSize[0x02A8] - InheritedSize[0x0260])
class UUI_Management_NPCLabels_C : public UUserWidget
{
public:
	...
	class UImage*                                      Image_157;                                                 // 0x0288(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UHorizontalBox*                              SkillsBox;                                                 // 0x0290(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<TEnumAsByte<E_Skills_E_Skills>>             SkillsInOrder;                                             // 0x0298(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Management_NPCLabels.UI_Management_NPCLabels_C");
		return ptr;
	}
