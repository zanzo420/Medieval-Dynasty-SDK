...
// BlueprintGeneratedClass BP_Building_Cowshed.BP_Building_Cowshed_C
// 0x0010 (FullSize[0x0768] - InheritedSize[0x0758])
class ABP_Building_Cowshed_C : public ABP_MasterBuilding_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Building_Cowshed.BP_Building_Cowshed_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Building_Cowshed(int EntryPoint);
};
