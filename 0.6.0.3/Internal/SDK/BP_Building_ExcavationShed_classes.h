...
// BlueprintGeneratedClass BP_Building_ExcavationShed.BP_Building_ExcavationShed_C
// 0x0018 (FullSize[0x0770] - InheritedSize[0x0758])
class ABP_Building_ExcavationShed_C : public ABP_MasterBuilding_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Building_ExcavationShed.BP_Building_ExcavationShed_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Building_ExcavationShed(int EntryPoint);
};
