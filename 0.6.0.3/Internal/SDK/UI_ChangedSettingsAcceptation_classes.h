...
// WidgetBlueprintGeneratedClass UI_ChangedSettingsAcceptation.UI_ChangedSettingsAcceptation_C
// 0x0088 (FullSize[0x02E8] - InheritedSize[0x0260])
class UUI_ChangedSettingsAcceptation_C : public UUserWidget
{
public:
	...
	class UWidgetSwitcher*                             WidgetSwitcher_2;                                          // 0x02B8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UUI_OptionsVerticalMenu_C*                   OptionsMenuReference;                                      // 0x02C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	struct FScriptMulticastDelegate                    AcceptSettings;                                            // 0x02C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FScriptMulticastDelegate                    CancelSettings;                                            // 0x02D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_ChangedSettingsAcceptation.UI_ChangedSettingsAcceptation_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_ChangedSettingsAcceptation(int EntryPoint);
	void CancelSettings__DelegateSignature();
	void AcceptSettings__DelegateSignature();
};
