...
// WidgetBlueprintGeneratedClass UI_GoalTalk_ItemSlot.UI_GoalTalk_ItemSlot_C
// 0x004A (FullSize[0x02AA] - InheritedSize[0x0260])
class UUI_GoalTalk_ItemSlot_C : public UUserWidget
{
public:
	...
	TEnumAsByte<E_GoalState_E_GoalState>               QuestState;                                                // 0x02A9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_GoalTalk_ItemSlot.UI_GoalTalk_ItemSlot_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UI_GoalTalk_ItemSlot(int EntryPoint);
};
