...
// AnimBlueprintGeneratedClass Lynx_AnimBP.Lynx_AnimBP_C
// 0x1610 (FullSize[0x18C8] - InheritedSize[0x02B8])
class ULynx_AnimBP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_AU8D[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_1NTX[0x8];                                     // 0x0908(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1N4S[0x3];                                     // 0x1885(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HSSX[0x2];                                     // 0x188E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2LIB[0x3];                                     // 0x18B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	class ABP_LynxAI_C*                                Lynx;                                                      // 0x18C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass Lynx_AnimBP.Lynx_AnimBP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Lynx_AnimBP(int EntryPoint);
};
