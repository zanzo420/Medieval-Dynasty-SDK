...
// WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_Population.UI_QuestTracker_GoalSlot_Population_C
// 0x0068 (FullSize[0x02F0] - InheritedSize[0x0288])
class UUI_QuestTracker_GoalSlot_Population_C : public UUI_QuestTracker_MasterGoalSlot_C
{
public:
	...
	unsigned char                                      UnknownData_G8ET[0x7];                                     // 0x02C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FST_Goal_Population                         Goal;                                                      // 0x02C8(0x0028) (Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_QuestTracker_GoalSlot_Population.UI_QuestTracker_GoalSlot_Population_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_UI_QuestTracker_GoalSlot_Population(int EntryPoint);
