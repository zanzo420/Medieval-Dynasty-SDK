...
// BlueprintGeneratedClass BP_BadgerAI.BP_BadgerAI_C
// 0x0019 (FullSize[0x0BE9] - InheritedSize[0x0BD0])
class ABP_BadgerAI_C : public ABP_GroundAnimalBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BadgerAI.BP_BadgerAI_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BadgerAI(int EntryPoint);
};
