...
// AnimBlueprintGeneratedClass Goat_young_AnimBP.Goat_young_AnimBP_C
// 0x1A7C (FullSize[0x1D34] - InheritedSize[0x02B8])
class UGoat_young_AnimBP_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_ZKDL[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_A1KZ[0x8];                                     // 0x0D68(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D27J[0x3];                                     // 0x1CE1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F50M[0x6];                                     // 0x1CEA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QPVR[0x3];                                     // 0x1CFD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EZRQ[0x4];                                     // 0x1D04(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T44F[0x3];                                     // 0x1D29(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("AnimBlueprintGeneratedClass Goat_young_AnimBP.Goat_young_AnimBP_C");
		return ptr;
	}
	...
	void UpdateIKState();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Goat_young_AnimBP_AnimGraphNode_TransitionResult_409538414182267DB2F9D59623B4640C();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Goat_young_AnimBP_AnimGraphNode_TransitionResult_AC0B5E87496A9F90348CB698A716F6DC();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Goat_young_AnimBP_AnimGraphNode_TransitionResult_658175494813F2D2FF932EBA9B91C612();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_Goat_young_AnimBP_AnimGraphNode_TransitionResult_DD22305945CABF2EDACA06A08917D6D6();
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void BlueprintBeginPlay();
	void ExecuteUbergraph_Goat_young_AnimBP(int EntryPoint);
};
