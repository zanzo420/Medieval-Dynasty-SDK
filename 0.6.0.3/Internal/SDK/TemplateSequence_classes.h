...
{
public:
	unsigned char                                      UnknownData_3Y4U[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TMCH[0x3C];                                    // 0x0034(0x003C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_A9OD[0x3];                                     // 0x00B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_575V[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PQKP[0x458];                                   // 0x0028(0x0458) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CADS[0x60];                                    // 0x0578(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XEGO[0x8];                                     // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HV6V[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5M59[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZP95[0x8];                                     // 0x0680(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4EAV[0x8];                                     // 0x0160(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3ZKB[0x70];                                    // 0x0040(0x0070) MISSED OFFSET (PADDING)
